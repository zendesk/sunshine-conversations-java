lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.jboss.resteasy" % "resteasy-client" % "5.0.0.Final" % "compile",
      "org.jboss.resteasy" % "resteasy-multipart-provider" % "5.0.0.Final" % "compile",
      "org.jboss.resteasy" % "resteasy-jackson2-provider" % "5.0.0.Final" % "compile",
