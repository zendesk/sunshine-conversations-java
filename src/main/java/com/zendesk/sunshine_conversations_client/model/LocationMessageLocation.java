...
@JsonTypeName("locationMessage_location")
...
public class LocationMessageLocation {
  ...
  public LocationMessageLocation() {
  }

  public LocationMessageLocation address(@jakarta.annotation.Nullable String address) {
  ...
  public LocationMessageLocation name(@jakarta.annotation.Nullable String name) {
