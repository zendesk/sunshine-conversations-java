...
public class AppListFilter {
  ...
  public AppListFilter serviceAccountId(@jakarta.annotation.Nullable String serviceAccountId) {
  ...
  @JsonProperty(JSON_PROPERTY_SERVICE_ACCOUNT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setServiceAccountId(@jakarta.annotation.Nullable String serviceAccountId) {
    this.serviceAccountId = serviceAccountId;
  }
