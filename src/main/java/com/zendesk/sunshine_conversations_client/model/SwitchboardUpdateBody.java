...
@JsonTypeName("switchboardUpdateBody")
...
public class SwitchboardUpdateBody {
  ...
  public SwitchboardUpdateBody() {
  }

  public SwitchboardUpdateBody enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  public SwitchboardUpdateBody defaultSwitchboardIntegrationId(@jakarta.annotation.Nullable String defaultSwitchboardIntegrationId) {
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_SWITCHBOARD_INTEGRATION_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultSwitchboardIntegrationId(@jakarta.annotation.Nullable String defaultSwitchboardIntegrationId) {
    this.defaultSwitchboardIntegrationId = defaultSwitchboardIntegrationId;
  }
