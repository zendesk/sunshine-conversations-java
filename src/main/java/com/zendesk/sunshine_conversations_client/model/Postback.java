...
public class Postback extends Action {
  ...
  public Postback type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public Postback text(@jakarta.annotation.Nonnull String text) {
  ...
  public Postback payload(@jakarta.annotation.Nonnull String payload) {
  ...
  public Postback metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
