...
@JsonTypeName("conversationMessageDeliveryPayload_message")
...
public class ConversationMessageDeliveryPayloadMessage {
  ...
  public ConversationMessageDeliveryPayloadMessage() {
  }

  public ConversationMessageDeliveryPayloadMessage id(@jakarta.annotation.Nullable String id) {
