...
@JsonTypeName("participantJoinBody")
...
public class ParticipantJoinBody {
  ...
  public ParticipantJoinBody() {
  }

  public ParticipantJoinBody userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ParticipantJoinBody subscribeSDKClient(@jakarta.annotation.Nullable Boolean subscribeSDKClient) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIBE_S_D_K_CLIENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubscribeSDKClient(@jakarta.annotation.Nullable Boolean subscribeSDKClient) {
    this.subscribeSDKClient = subscribeSDKClient;
  }

  public ParticipantJoinBody userExternalId(@jakarta.annotation.Nullable String userExternalId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, participantJoinBody.userId) &&
        Objects.equals(this.subscribeSDKClient, participantJoinBody.subscribeSDKClient) &&
        Objects.equals(this.userExternalId, participantJoinBody.userExternalId);
  }
