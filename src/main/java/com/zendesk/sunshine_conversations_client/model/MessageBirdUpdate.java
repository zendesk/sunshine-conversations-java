 ...
 */
@JsonPropertyOrder({
  MessageBirdUpdate.JSON_PROPERTY_DISPLAY_NAME,
  MessageBirdUpdate.JSON_PROPERTY_DEFAULT_RESPONDER_ID
})
@JsonTypeName("messageBirdUpdate")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class MessageBirdUpdate implements IntegrationUpdate {
  ...
  public MessageBirdUpdate() {
  }

  public MessageBirdUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public MessageBirdUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    MessageBirdUpdate messageBirdUpdate = (MessageBirdUpdate) o;
    return Objects.equals(this.displayName, messageBirdUpdate.displayName) &&
        Objects.equals(this.defaultResponderId, messageBirdUpdate.defaultResponderId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageBirdUpdate {\n");
