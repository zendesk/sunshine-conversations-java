...
@JsonTypeName("attachmentResponse")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class AttachmentResponse {
  public static final String JSON_PROPERTY_ATTACHMENT = "attachment";
  @jakarta.annotation.Nullable
  private AttachmentSchema attachment;

  public AttachmentResponse() {
  }

  public AttachmentResponse attachment(@jakarta.annotation.Nullable AttachmentSchema attachment) {
  ...
  @JsonProperty(JSON_PROPERTY_ATTACHMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttachment(@jakarta.annotation.Nullable AttachmentSchema attachment) {
    this.attachment = attachment;
  }
