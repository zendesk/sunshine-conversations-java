...
public class FileMessage extends Content {
  ...
  /**
   * An optional description of the file for accessibility purposes. The field will be saved by
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, mediaUrl, mediaSize, mediaType, altText, text, blockChatInput,
        htmlText, markdownText, attachmentId);
  }
