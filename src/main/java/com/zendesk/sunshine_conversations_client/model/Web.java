...
public class Web extends Integration {
  ...
  public Web defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Web defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Web type(@jakarta.annotation.Nullable String type) {
  ...
  public Web brandColor(@jakarta.annotation.Nullable String brandColor) {
  ...
  public Web fixedIntroPane(@jakarta.annotation.Nullable Boolean fixedIntroPane) {
  ...
  public Web conversationColor(@jakarta.annotation.Nullable String conversationColor) {
  ...
  public Web actionColor(@jakarta.annotation.Nullable String actionColor) {
  ...
  public Web displayStyle(@jakarta.annotation.Nullable String displayStyle) {
  ...
  public Web buttonIconUrl(@jakarta.annotation.Nullable String buttonIconUrl) {
  ...
  public Web buttonWidth(@jakarta.annotation.Nullable String buttonWidth) {
  ...
  public Web buttonHeight(@jakarta.annotation.Nullable String buttonHeight) {
  ...
  public Web integrationOrder(@jakarta.annotation.Nullable List<String> integrationOrder) {
  ...
  public Web businessName(@jakarta.annotation.Nullable String businessName) {
  ...
  public Web businessIconUrl(@jakarta.annotation.Nullable String businessIconUrl) {
  ...
  public Web backgroundImageUrl(@jakarta.annotation.Nullable String backgroundImageUrl) {
  ...
  public Web originWhitelist(@jakarta.annotation.Nullable List<String> originWhitelist) {
  ...
  public Web prechatCapture(@jakarta.annotation.Nullable PrechatCapture prechatCapture) {
  ...
  public Web canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public Web canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
  ...
  @Override
  public Web status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Web displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    Web web = (Web) o;
    return Objects.equals(this.defaultResponderId, web.defaultResponderId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, brandColor, fixedIntroPane, conversationColor, actionColor, displayStyle, buttonIconUrl, buttonWidth, buttonHeight, integrationOrder, businessName, businessIconUrl, backgroundImageUrl, originWhitelist, prechatCapture, canUserSeeConversationList, canUserCreateMoreConversations, attachmentsEnabled, super.hashCode());
  }
