...
@JsonTypeName("clientUpdateEvent_allOf_payload")
...
public class ClientUpdateEventAllOfPayload {
  ...
  public ClientUpdateEventAllOfPayload() {
  }

  public ClientUpdateEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ClientUpdateEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
  ...
  public ClientUpdateEventAllOfPayload client(@jakarta.annotation.Nullable Client client) {
  ...
  public ClientUpdateEventAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
