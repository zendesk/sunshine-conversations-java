...
@JsonTypeName("downloadMessageRefBody_allOf_apple")
...
public class DownloadMessageRefBodyAllOfApple {
  ...
  public DownloadMessageRefBodyAllOfApple() {
  }

  public DownloadMessageRefBodyAllOfApple interactiveDataRef(@jakarta.annotation.Nonnull DownloadMessageRefBodyAllOfAppleInteractiveDataRef interactiveDataRef) {
  ...
  @JsonProperty(JSON_PROPERTY_INTERACTIVE_DATA_REF)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInteractiveDataRef(@jakarta.annotation.Nonnull DownloadMessageRefBodyAllOfAppleInteractiveDataRef interactiveDataRef) {
    this.interactiveDataRef = interactiveDataRef;
  }
