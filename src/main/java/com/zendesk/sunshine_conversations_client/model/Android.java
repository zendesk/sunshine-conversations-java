...
public class Android extends Integration {
  ...
  public Android defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Android defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Android type(@jakarta.annotation.Nullable String type) {
  ...
  public Android projectId(@jakarta.annotation.Nullable String projectId) {
  ...
  public Android clientEmail(@jakarta.annotation.Nullable String clientEmail) {
  ...
  public Android privateKey(@jakarta.annotation.Nullable String privateKey) {
  ...
  public Android serverKey(@jakarta.annotation.Nullable String serverKey) {
  ...
  public Android senderId(@jakarta.annotation.Nullable String senderId) {
  ...
  public Android canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public Android canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
  ...
  @Override
  public Android status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Android displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultResponderId, android.defaultResponderId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, projectId, clientEmail, privateKey, serverKey, senderId, canUserSeeConversationList, canUserCreateMoreConversations, attachmentsEnabled, super.hashCode());
  }
