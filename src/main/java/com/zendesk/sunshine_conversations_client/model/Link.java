...
@JsonPropertyOrder({
    ...
    Link.JSON_PROPERTY_TEXT,
    Link.JSON_PROPERTY_DEFAULT,
...
public class Link extends Action {
  ...
  public Link type(@jakarta.annotation.Nonnull String type) {
  ...
  public Link uri(@jakarta.annotation.Nonnull String uri) {
  ...
  public Link text(@jakarta.annotation.Nonnull String text) {
  ...
  public Link _default(@jakarta.annotation.Nullable Boolean _default) {
  ...
  public Link metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {

    this.metadata = metadata;
    return this;
  }

  public Link putMetadataItem(String key, Object metadataItem) {
  ...
  public Link extraChannelOptions(
