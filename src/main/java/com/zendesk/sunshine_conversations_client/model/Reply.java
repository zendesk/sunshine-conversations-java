...
public class Reply implements Action {
  ...
  public Reply text(@jakarta.annotation.Nonnull String text) {
  ...
  public Reply payload(@jakarta.annotation.Nonnull String payload) {
  ...
  public Reply metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public Reply iconUrl(@jakarta.annotation.Nullable String iconUrl) {
