...
@JsonTypeName("messagebird")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class MatchCriteriaMessagebird extends MatchCriteria {
  ...
  public MatchCriteriaMessagebird() {
    this.type = "messagebird";
  }

  public MatchCriteriaMessagebird type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public MatchCriteriaMessagebird integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteriaMessagebird primary(@jakarta.annotation.Nullable Boolean primary) {
  ...
  public MatchCriteriaMessagebird phoneNumber(@jakarta.annotation.Nonnull String phoneNumber) {
