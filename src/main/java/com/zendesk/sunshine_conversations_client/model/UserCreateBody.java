...
public class UserCreateBody {
  ...
  public UserCreateBody externalId(@jakarta.annotation.Nonnull String externalId) {
  ...
  /**
   * A unique identifier for the user. The &#x60;externalId&#x60; can be used to link a user to the same conversation [across multiple devices](https://developer.zendesk.com/documentation/conversations/messaging-platform/users/authenticating-users/). 
   * @return externalId
   */
  @jakarta.annotation.Nonnull
  ...
  public UserCreateBody signedUpAt(@jakarta.annotation.Nullable String signedUpAt) {
  ...
  public UserCreateBody toBeRetained(@jakarta.annotation.Nullable Boolean toBeRetained) {
  ...
  public UserCreateBody profile(@jakarta.annotation.Nullable Profile profile) {
  ...
  public UserCreateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
