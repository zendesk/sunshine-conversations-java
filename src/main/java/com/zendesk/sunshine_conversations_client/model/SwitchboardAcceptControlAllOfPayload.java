...
@JsonTypeName("switchboardAcceptControl_allOf_payload")
...
public class SwitchboardAcceptControlAllOfPayload {
  ...
  public SwitchboardAcceptControlAllOfPayload() {
  }

  public SwitchboardAcceptControlAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public SwitchboardAcceptControlAllOfPayload metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public SwitchboardAcceptControlAllOfPayload putMetadataItem(String key, Object metadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardAcceptControlAllOfPayload switchboardAcceptControlAllOfPayload = (SwitchboardAcceptControlAllOfPayload) o;
    return Objects.equals(this.conversation, switchboardAcceptControlAllOfPayload.conversation) &&
        Objects.equals(this.metadata, switchboardAcceptControlAllOfPayload.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardAcceptControlAllOfPayload {\n");
