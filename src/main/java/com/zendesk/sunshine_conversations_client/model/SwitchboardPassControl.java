...
@JsonTypeName("switchboardPassControl")
...
public class SwitchboardPassControl {
  ...
  public SwitchboardPassControl() {
  }

  public SwitchboardPassControl id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardPassControl type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardPassControl createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardPassControl payload(@jakarta.annotation.Nullable SwitchboardPassControlAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable SwitchboardPassControlAllOfPayload payload) {
    this.payload = payload;
  }
