...
@JsonTypeName("conversationReadEvent")
...
public class ConversationReadEvent {
  ...
  public ConversationReadEvent() {
  }

  public ConversationReadEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationReadEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationReadEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationReadEvent payload(@jakarta.annotation.Nullable ConversationReadEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationReadEventAllOfPayload payload) {
    this.payload = payload;
  }
