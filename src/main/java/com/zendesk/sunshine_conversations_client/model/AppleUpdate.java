...
public class AppleUpdate implements IntegrationUpdate {
  ...
  public AppleUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public AppleUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public AppleUpdate authenticationMessageSecret(@jakarta.annotation.Nullable String authenticationMessageSecret) {
