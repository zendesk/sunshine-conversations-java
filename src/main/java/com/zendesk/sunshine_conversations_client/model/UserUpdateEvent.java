...
import com.zendesk.sunshine_conversations_client.model.UserUpdateEventAllOfPayload;
 ...
 */
@JsonPropertyOrder({
  UserUpdateEvent.JSON_PROPERTY_ID,
  UserUpdateEvent.JSON_PROPERTY_TYPE,
  UserUpdateEvent.JSON_PROPERTY_CREATED_AT,
  UserUpdateEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("userUpdateEvent")
...
public class UserUpdateEvent {
  ...
  @jakarta.annotation.Nullable
  private UserUpdateEventAllOfPayload payload;

  public UserUpdateEvent() {
  }

  public UserUpdateEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public UserUpdateEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public UserUpdateEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public UserUpdateEvent payload(@jakarta.annotation.Nullable UserUpdateEventAllOfPayload payload) {
  ...
  public UserUpdateEventAllOfPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable UserUpdateEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserUpdateEvent userUpdateEvent = (UserUpdateEvent) o;
    return Objects.equals(this.id, userUpdateEvent.id) &&
        Objects.equals(this.type, userUpdateEvent.type) &&
        Objects.equals(this.createdAt, userUpdateEvent.createdAt) &&
        Objects.equals(this.payload, userUpdateEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserUpdateEvent {\n");
