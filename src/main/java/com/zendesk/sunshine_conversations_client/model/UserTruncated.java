...
@JsonPropertyOrder({
  ...
  UserTruncated.JSON_PROPERTY_AUTHENTICATED,
  UserTruncated.JSON_PROPERTY_EXTERNAL_ID,
  UserTruncated.JSON_PROPERTY_ZENDESK_ID
})
@JsonTypeName("userTruncated")
...
public class UserTruncated {
  ...
  public UserTruncated id(@jakarta.annotation.Nullable String id) {
  ...
  public UserTruncated externalId(@jakarta.annotation.Nullable String externalId) {
  ...
  public UserTruncated zendeskId(@jakarta.annotation.Nullable String zendeskId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userTruncated.id) &&
        Objects.equals(this.authenticated, userTruncated.authenticated) &&
        Objects.equals(this.externalId, userTruncated.externalId) &&
        Objects.equals(this.zendeskId, userTruncated.zendeskId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, authenticated, externalId, zendeskId);
  }
