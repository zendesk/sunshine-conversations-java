...
public class PostbackWebhook {
  ...
  public PostbackWebhook() {
  }

  public PostbackWebhook payload(@jakarta.annotation.Nullable String payload) {
  ...
  public PostbackWebhook metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
