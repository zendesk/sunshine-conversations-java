...
@JsonTypeName("acceptControlBody")
...
public class AcceptControlBody {
  ...
  public AcceptControlBody() {
  }

  public AcceptControlBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public AcceptControlBody putMetadataItem(String key, Object metadataItem) {
