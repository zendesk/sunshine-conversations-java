 ...
 */
@JsonPropertyOrder({
  SwitchboardOfferControlFailure.JSON_PROPERTY_ID,
  SwitchboardOfferControlFailure.JSON_PROPERTY_TYPE,
  SwitchboardOfferControlFailure.JSON_PROPERTY_CREATED_AT,
  SwitchboardOfferControlFailure.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardOfferControlFailure")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardOfferControlFailure {
  ...
  public SwitchboardOfferControlFailure() {
  }

  public SwitchboardOfferControlFailure id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardOfferControlFailure type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardOfferControlFailure createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardOfferControlFailure payload(@jakarta.annotation.Nullable SwitchboardAcceptControlFailureAllOfPayload payload) {
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardOfferControlFailure {\n");
