...
@JsonTypeName("conversationReadEvent_allOf_payload")
...
public class ConversationReadEventAllOfPayload {
  ...
  public ConversationReadEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationReadEventAllOfPayload activity(@jakarta.annotation.Nullable ConversationReadEventAllOfPayloadActivity activity) {
  ...
  @JsonProperty(JSON_PROPERTY_ACTIVITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActivity(@jakarta.annotation.Nullable ConversationReadEventAllOfPayloadActivity activity) {
    this.activity = activity;
  }
