 ...
 */
@JsonPropertyOrder({
  UserRemoveEvent.JSON_PROPERTY_ID,
  UserRemoveEvent.JSON_PROPERTY_TYPE,
  UserRemoveEvent.JSON_PROPERTY_CREATED_AT,
  UserRemoveEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("userRemoveEvent")
...
public class UserRemoveEvent {
  ...
  public UserRemoveEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public UserRemoveEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public UserRemoveEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public UserRemoveEvent payload(@jakarta.annotation.Nullable UserRemoveEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable UserRemoveEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserRemoveEvent userRemoveEvent = (UserRemoveEvent) o;
    return Objects.equals(this.id, userRemoveEvent.id) &&
        Objects.equals(this.type, userRemoveEvent.type) &&
        Objects.equals(this.createdAt, userRemoveEvent.createdAt) &&
        Objects.equals(this.payload, userRemoveEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserRemoveEvent {\n");
