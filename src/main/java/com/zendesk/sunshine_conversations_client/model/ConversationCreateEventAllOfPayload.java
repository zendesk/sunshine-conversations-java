...
public class ConversationCreateEventAllOfPayload {
  ...
  private JsonNullable<User2> user = JsonNullable.<User2>of(null);
  ...
  **/
  ...
  public ConversationCreateEventAllOfPayload user(User2 user) {
    this.user = JsonNullable.<User2>of(user);
  ...
  **/
  ...
  public JsonNullable<User2> getUser_JsonNullable() {
    return user;
  }
  
  @JsonProperty(JSON_PROPERTY_USER)
  public void setUser_JsonNullable(JsonNullable<User2> user) {
    this.user = user;
  }
