...
@JsonTypeName("conversationCreateEvent_allOf_payload")
...
public class ConversationCreateEventAllOfPayload {
  ...
  public ConversationCreateEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationCreateEventAllOfPayload creationReason(@jakarta.annotation.Nullable CreationReasonEnum creationReason) {
  ...
  @JsonProperty(JSON_PROPERTY_CREATION_REASON)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreationReason(@jakarta.annotation.Nullable CreationReasonEnum creationReason) {
    this.creationReason = creationReason;
  }

  public ConversationCreateEventAllOfPayload source(@jakarta.annotation.Nullable SourceWithCampaignWebhook source) {
  ...
  public ConversationCreateEventAllOfPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public ConversationCreateEventAllOfPayload referral(@jakarta.annotation.Nullable Referral referral) {
