...
@JsonTypeName("conversationRemoveEvent")
...
public class ConversationRemoveEvent {
  ...
  public ConversationRemoveEvent() {
  }

  public ConversationRemoveEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationRemoveEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationRemoveEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationRemoveEvent payload(@jakarta.annotation.Nullable ConversationRemoveEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationRemoveEventAllOfPayload payload) {
    this.payload = payload;
  }
