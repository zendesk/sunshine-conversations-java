 ...
 */
@JsonPropertyOrder({
  ClientUpdateEvent.JSON_PROPERTY_ID,
  ClientUpdateEvent.JSON_PROPERTY_TYPE,
  ClientUpdateEvent.JSON_PROPERTY_CREATED_AT,
  ClientUpdateEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("clientUpdateEvent")
...
public class ClientUpdateEvent {
  ...
  public ClientUpdateEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ClientUpdateEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ClientUpdateEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ClientUpdateEvent payload(@jakarta.annotation.Nullable ClientUpdateEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ClientUpdateEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientUpdateEvent {\n");
