...
public class Profile {
  ...
  public Profile givenName(@jakarta.annotation.Nullable String givenName) {
  ...
  public Profile surname(@jakarta.annotation.Nullable String surname) {
  ...
  public Profile email(@jakarta.annotation.Nullable String email) {
  ...
  public Profile avatarUrl(@jakarta.annotation.Nullable URI avatarUrl) {
