...
public class Switchboard {
  ...
  public Switchboard id(@jakarta.annotation.Nonnull String id) {
  ...
  public Switchboard enabled(@jakarta.annotation.Nonnull Boolean enabled) {
  ...
  public Switchboard defaultSwitchboardIntegrationId(@jakarta.annotation.Nullable String defaultSwitchboardIntegrationId) {
