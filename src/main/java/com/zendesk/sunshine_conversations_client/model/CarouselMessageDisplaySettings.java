...
@JsonTypeName("carouselMessage_displaySettings")
...
public class CarouselMessageDisplaySettings {
  ...
  public CarouselMessageDisplaySettings() {
  }

  public CarouselMessageDisplaySettings imageAspectRatio(@jakarta.annotation.Nullable ImageAspectRatioEnum imageAspectRatio) {
  ...
  @JsonProperty(JSON_PROPERTY_IMAGE_ASPECT_RATIO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setImageAspectRatio(@jakarta.annotation.Nullable ImageAspectRatioEnum imageAspectRatio) {
    this.imageAspectRatio = imageAspectRatio;
  }
