...
public class ParticipantResponse {
  ...
  public ParticipantResponse participant(@jakarta.annotation.Nullable Participant participant) {
  ...
  @JsonProperty(JSON_PROPERTY_PARTICIPANT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParticipant(@jakarta.annotation.Nullable Participant participant) {
    this.participant = participant;
  }
