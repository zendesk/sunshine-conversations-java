 ...
 */
@JsonPropertyOrder({
  DefaultResponderId.JSON_PROPERTY_DEFAULT_RESPONDER_ID
})
@JsonTypeName("defaultResponderId")
...
public class DefaultResponderId {
  ...
  public DefaultResponderId() {
  }

  public DefaultResponderId defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    DefaultResponderId defaultResponderId = (DefaultResponderId) o;
    return Objects.equals(this.defaultResponderId, defaultResponderId.defaultResponderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId);
  }
