...
public class Twilio extends Integration {
  ...
  public Twilio defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Twilio defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Twilio type(@jakarta.annotation.Nullable String type) {
  ...
  public Twilio accountSid(@jakarta.annotation.Nonnull String accountSid) {
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT_SID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAccountSid(@jakarta.annotation.Nonnull String accountSid) {
    this.accountSid = accountSid;
  }

  public Twilio authToken(@jakarta.annotation.Nullable String authToken) {
  ...
  @JsonProperty(JSON_PROPERTY_AUTH_TOKEN)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAuthToken(@jakarta.annotation.Nullable String authToken) {
    this.authToken = authToken;
  }

  public Twilio phoneNumberSid(@jakarta.annotation.Nullable String phoneNumberSid) {
  ...
  @JsonProperty(JSON_PROPERTY_PHONE_NUMBER_SID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPhoneNumberSid(@jakarta.annotation.Nullable String phoneNumberSid) {
    this.phoneNumberSid = phoneNumberSid;
  }

  public Twilio messagingServiceSid(@jakarta.annotation.Nullable String messagingServiceSid) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGING_SERVICE_SID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessagingServiceSid(@jakarta.annotation.Nullable String messagingServiceSid) {
    this.messagingServiceSid = messagingServiceSid;
  }

  @Override
  public Twilio status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Twilio displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultResponderId, twilio.defaultResponderId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, accountSid, authToken, phoneNumberSid, messagingServiceSid, super.hashCode());
  }
