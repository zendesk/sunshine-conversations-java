...
@JsonTypeName("quotedMessageExternalMessageId")
...
public class QuotedMessageExternalMessageId {
  ...
  public QuotedMessageExternalMessageId externalMessageId(@jakarta.annotation.Nullable String externalMessageId) {
