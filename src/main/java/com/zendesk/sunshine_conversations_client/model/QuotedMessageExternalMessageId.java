...
@JsonTypeName("externalMessageId")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class QuotedMessageExternalMessageId extends QuotedMessage {
  ...
  public QuotedMessageExternalMessageId() {
    this.type = "externalMessageId";
  }

  public QuotedMessageExternalMessageId type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }

  /**
   * The type of quotedMessage - &#x60;externalMessageId&#x60; if no Sunshine Conversations message
   * matched the quoted message.
   *
   * @return type
   */
  ...
  public QuotedMessageExternalMessageId externalMessageId(
      @jakarta.annotation.Nullable String externalMessageId) {
