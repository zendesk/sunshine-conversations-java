...
@JsonTypeName("locationMessage_coordinates")
...
public class LocationMessageCoordinates {
  ...
  public LocationMessageCoordinates() {
  }

  public LocationMessageCoordinates lat(@jakarta.annotation.Nonnull BigDecimal lat) {
  ...
  public LocationMessageCoordinates _long(@jakarta.annotation.Nonnull BigDecimal _long) {
  ...
  @JsonProperty(JSON_PROPERTY_LONG)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLong(@jakarta.annotation.Nonnull BigDecimal _long) {
    this._long = _long;
  }
