...
public class AppCreateBody {
  ...
  public AppCreateBody() {
  }

  public AppCreateBody displayName(@jakarta.annotation.Nonnull String displayName) {
  ...
  public AppCreateBody settings(@jakarta.annotation.Nullable AppSettings settings) {
  ...
  public AppCreateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
