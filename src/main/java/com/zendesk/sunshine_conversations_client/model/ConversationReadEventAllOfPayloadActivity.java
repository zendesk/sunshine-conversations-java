...
@JsonTypeName("conversationReadEvent_allOf_payload_activity")
...
public class ConversationReadEventAllOfPayloadActivity {
  ...
  public ConversationReadEventAllOfPayloadActivity() {
  }

  public ConversationReadEventAllOfPayloadActivity type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationReadEventAllOfPayloadActivity source(@jakarta.annotation.Nullable SourceWebhook source) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(@jakarta.annotation.Nullable SourceWebhook source) {
    this.source = source;
  }

  public ConversationReadEventAllOfPayloadActivity author(@jakarta.annotation.Nullable AuthorWebhook author) {
  ...
  @JsonProperty(JSON_PROPERTY_AUTHOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAuthor(@jakarta.annotation.Nullable AuthorWebhook author) {
    this.author = author;
  }
