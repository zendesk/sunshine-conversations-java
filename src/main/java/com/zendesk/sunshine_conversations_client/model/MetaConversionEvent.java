...
@JsonTypeName("metaConversionEvent")
...
public class MetaConversionEvent {
  ...
  public MetaConversionEvent() {
  }

  public MetaConversionEvent payload(@jakarta.annotation.Nonnull MetaConversionEventPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPayload(@jakarta.annotation.Nonnull MetaConversionEventPayload payload) {
    this.payload = payload;
  }
