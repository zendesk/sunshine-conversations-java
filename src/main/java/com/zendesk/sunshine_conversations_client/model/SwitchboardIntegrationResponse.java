...
@JsonTypeName("switchboardIntegrationResponse")
...
public class SwitchboardIntegrationResponse {
  ...
  public SwitchboardIntegrationResponse() {
  }

  public SwitchboardIntegrationResponse switchboardIntegration(@jakarta.annotation.Nullable SwitchboardIntegration switchboardIntegration) {
  ...
  @JsonProperty(JSON_PROPERTY_SWITCHBOARD_INTEGRATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSwitchboardIntegration(@jakarta.annotation.Nullable SwitchboardIntegration switchboardIntegration) {
    this.switchboardIntegration = switchboardIntegration;
  }
