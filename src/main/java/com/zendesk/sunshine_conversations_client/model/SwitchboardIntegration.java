...
@JsonTypeName("switchboardIntegration")
...
public class SwitchboardIntegration {
  ...
  @jakarta.annotation.Nullable
  private Integer messageHistoryCount;

  public SwitchboardIntegration() {
  }

  public SwitchboardIntegration id(@jakarta.annotation.Nonnull String id) {
  ...
  public SwitchboardIntegration name(@jakarta.annotation.Nonnull String name) {
  ...
  public SwitchboardIntegration integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public SwitchboardIntegration integrationType(@jakarta.annotation.Nonnull String integrationType) {
  ...
  @JsonProperty(JSON_PROPERTY_INTEGRATION_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIntegrationType(@jakarta.annotation.Nonnull String integrationType) {
    this.integrationType = integrationType;
  }

  public SwitchboardIntegration deliverStandbyEvents(@jakarta.annotation.Nonnull Boolean deliverStandbyEvents) {
  ...
  @JsonProperty(JSON_PROPERTY_DELIVER_STANDBY_EVENTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDeliverStandbyEvents(@jakarta.annotation.Nonnull Boolean deliverStandbyEvents) {
    this.deliverStandbyEvents = deliverStandbyEvents;
  }

  public SwitchboardIntegration nextSwitchboardIntegrationId(@jakarta.annotation.Nullable String nextSwitchboardIntegrationId) {
  ...
  public SwitchboardIntegration messageHistoryCount(@jakarta.annotation.Nullable Integer messageHistoryCount) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE_HISTORY_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessageHistoryCount(@jakarta.annotation.Nullable Integer messageHistoryCount) {
    this.messageHistoryCount = messageHistoryCount;
  }
