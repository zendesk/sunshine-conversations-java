...
@JsonTypeName("integrationResponse")
...
public class IntegrationResponse {
  ...
  public IntegrationResponse integration(@jakarta.annotation.Nullable Integration integration) {
  ...
  @JsonProperty(JSON_PROPERTY_INTEGRATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntegration(@jakarta.annotation.Nullable Integration integration) {
    this.integration = integration;
  }
