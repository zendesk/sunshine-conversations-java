...
public class EventSubSchema {
  ...
  public EventSubSchema() {
  }

  public EventSubSchema id(@jakarta.annotation.Nullable String id) {
  ...
  public EventSubSchema type(@jakarta.annotation.Nullable String type) {
  ...
  public EventSubSchema createdAt(@jakarta.annotation.Nullable String createdAt) {
