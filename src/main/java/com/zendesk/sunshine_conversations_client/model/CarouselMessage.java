...
/**
 * Carousel messages are a horizontally scrollable set of items that may each contain text, an
 * image, and message actions. Not all messaging channels fully support carousel messages; currently
 * only Facebook Messenger, LINE, Telegram, Viber, the Web Messenger, the Android SDK and the iOS
 * SDK cover the full functionality. For all other platforms a carousel message is rendered as raw
 * text. The raw text fallback does not include any images or postback message actions.
 */
@JsonPropertyOrder({
    CarouselMessage.JSON_PROPERTY_TYPE,
    CarouselMessage.JSON_PROPERTY_TEXT,
    CarouselMessage.JSON_PROPERTY_BLOCK_CHAT_INPUT,
...
public class CarouselMessage extends Content {
  ...
  public CarouselMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public CarouselMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public CarouselMessage items(@jakarta.annotation.Nonnull List<Item> items) {
  ...
  public CarouselMessage displaySettings(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, carouselMessage.type) &&
        ...
        Objects.equals(this.blockChatInput, carouselMessage.blockChatInput) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, text, blockChatInput, items, displaySettings);
  }
