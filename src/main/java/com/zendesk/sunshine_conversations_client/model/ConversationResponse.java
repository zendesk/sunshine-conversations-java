...
@JsonTypeName("conversationResponse")
...
public class ConversationResponse {
  ...
  public ConversationResponse conversation(@jakarta.annotation.Nullable Conversation conversation) {
  ...
  @JsonProperty(JSON_PROPERTY_CONVERSATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversation(@jakarta.annotation.Nullable Conversation conversation) {
    this.conversation = conversation;
  }
