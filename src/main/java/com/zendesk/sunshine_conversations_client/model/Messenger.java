...
public class Messenger extends Integration {
  ...
  public Messenger defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Messenger defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Messenger type(@jakarta.annotation.Nullable String type) {
  ...
  public Messenger pageAccessToken(@jakarta.annotation.Nullable String pageAccessToken) {
  ...
  public Messenger appId(@jakarta.annotation.Nonnull String appId) {
  ...
  public Messenger appSecret(@jakarta.annotation.Nullable String appSecret) {
  ...
  public Messenger pageId(@jakarta.annotation.Nullable BigDecimal pageId) {
  ...
  @JsonProperty(JSON_PROPERTY_PAGE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPageId(@jakarta.annotation.Nullable BigDecimal pageId) {
    this.pageId = pageId;
  }

  public Messenger pageName(@jakarta.annotation.Nullable String pageName) {
  ...
  @JsonProperty(JSON_PROPERTY_PAGE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPageName(@jakarta.annotation.Nullable String pageName) {
    this.pageName = pageName;
  }

  @Override
  public Messenger status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Messenger displayName(@jakarta.annotation.Nullable String displayName) {
