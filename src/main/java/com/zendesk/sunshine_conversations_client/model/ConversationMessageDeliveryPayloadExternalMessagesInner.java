 ...
 */
@JsonPropertyOrder({
  ConversationMessageDeliveryPayloadExternalMessagesInner.JSON_PROPERTY_ID
})
@JsonTypeName("conversationMessageDeliveryPayload_externalMessages_inner")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ConversationMessageDeliveryPayloadExternalMessagesInner {
  public static final String JSON_PROPERTY_ID = "id";
  @jakarta.annotation.Nullable
  private String id;

  public ConversationMessageDeliveryPayloadExternalMessagesInner() {
  }

  public ConversationMessageDeliveryPayloadExternalMessagesInner id(@jakarta.annotation.Nullable String id) {
  ...
  public boolean equals(Object o) {
    ...
    ConversationMessageDeliveryPayloadExternalMessagesInner conversationMessageDeliveryPayloadExternalMessagesInner = (ConversationMessageDeliveryPayloadExternalMessagesInner) o;
    return Objects.equals(this.id, conversationMessageDeliveryPayloadExternalMessagesInner.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationMessageDeliveryPayloadExternalMessagesInner {\n");
