...
@JsonTypeName("downloadMessageRefBody")
...
public class DownloadMessageRefBody {
  ...
  public DownloadMessageRefBody() {
  }

  public DownloadMessageRefBody userId(@jakarta.annotation.Nonnull String userId) {
  ...
  public DownloadMessageRefBody apple(@jakarta.annotation.Nullable DownloadMessageRefBodyAllOfApple apple) {
  ...
  @JsonProperty(JSON_PROPERTY_APPLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApple(@jakarta.annotation.Nullable DownloadMessageRefBodyAllOfApple apple) {
    this.apple = apple;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, downloadMessageRefBody.userId) &&
        Objects.equals(this.apple, downloadMessageRefBody.apple);
  }
