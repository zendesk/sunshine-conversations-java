...
public class Webhook {
  ...
  public Webhook target(@jakarta.annotation.Nonnull String target) {
  ...
  public Webhook triggers(@jakarta.annotation.Nonnull List<String> triggers) {
  ...
  public Webhook includeFullUser(@jakarta.annotation.Nullable Boolean includeFullUser) {
  ...
  public Webhook includeFullSource(@jakarta.annotation.Nullable Boolean includeFullSource) {
