...
@JsonTypeName("conversationMessageDeliveryPayload")
...
public class ConversationMessageDeliveryPayload {
  ...
  public ConversationMessageDeliveryPayload() {
  }

  public ConversationMessageDeliveryPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public ConversationMessageDeliveryPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationMessageDeliveryPayload message(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadMessage message) {
  ...
  public ConversationMessageDeliveryPayload destination(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadDestination destination) {
  ...
  public ConversationMessageDeliveryPayload externalMessages(@jakarta.annotation.Nullable List<ConversationMessageDeliveryPayloadExternalMessagesInner> externalMessages) {
    
    this.externalMessages = externalMessages;
    return this;
  }

  public ConversationMessageDeliveryPayload addExternalMessagesItem(ConversationMessageDeliveryPayloadExternalMessagesInner externalMessagesItem) {
  ...
  public ConversationMessageDeliveryPayload isFinalEvent(@jakarta.annotation.Nullable Boolean isFinalEvent) {
