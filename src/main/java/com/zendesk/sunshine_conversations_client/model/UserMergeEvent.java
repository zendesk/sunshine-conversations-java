 ...
 */
@JsonPropertyOrder({
  UserMergeEvent.JSON_PROPERTY_ID,
  UserMergeEvent.JSON_PROPERTY_TYPE,
  UserMergeEvent.JSON_PROPERTY_CREATED_AT,
  UserMergeEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("userMergeEvent")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class UserMergeEvent {
  ...
  @jakarta.annotation.Nullable
  private UserMergeEventAllOfPayload payload;

  public UserMergeEvent() {
  }

  public UserMergeEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public UserMergeEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public UserMergeEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public UserMergeEvent payload(@jakarta.annotation.Nullable UserMergeEventAllOfPayload payload) {
  ...
  public UserMergeEventAllOfPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable UserMergeEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public String toString() {
    ...
    sb.append("class UserMergeEvent {\n");
