...
@JsonPropertyOrder({
    ...
    ImageMessage.JSON_PROPERTY_BLOCK_CHAT_INPUT,
    ImageMessage.JSON_PROPERTY_HTML_TEXT,
    ImageMessage.JSON_PROPERTY_MARKDOWN_TEXT,
    ImageMessage.JSON_PROPERTY_ACTIONS,
    ImageMessage.JSON_PROPERTY_ATTACHMENT_ID
})
@JsonTypeName("image")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ImageMessage extends Content {
  ...
  public ImageMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public ImageMessage mediaUrl(@jakarta.annotation.Nonnull URI mediaUrl) {
  ...
  public ImageMessage altText(@jakarta.annotation.Nullable String altText) {
  ...
  public ImageMessage text(@jakarta.annotation.Nullable String text) {
  ...
  public ImageMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public ImageMessage htmlText(@jakarta.annotation.Nullable String htmlText) {
  ...
  public ImageMessage markdownText(@jakarta.annotation.Nullable String markdownText) {
  ...
  public ImageMessage actions(@jakarta.annotation.Nullable List<Action> actions) {
  ...
  public ImageMessage attachmentId(@jakarta.annotation.Nullable String attachmentId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, imageMessage.type) &&
        ...
        Objects.equals(this.blockChatInput, imageMessage.blockChatInput) &&
        Objects.equals(this.htmlText, imageMessage.htmlText) &&
        Objects.equals(this.markdownText, imageMessage.markdownText) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, mediaUrl, mediaType, mediaSize, altText, text, blockChatInput,
        htmlText, markdownText, actions, attachmentId);
  }
