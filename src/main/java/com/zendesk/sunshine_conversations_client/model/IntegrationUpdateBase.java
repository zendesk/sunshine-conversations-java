...
@JsonTypeName("integrationUpdateBase")
...
public class IntegrationUpdateBase {
  ...
  public IntegrationUpdateBase() {
  }

  public IntegrationUpdateBase displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public IntegrationUpdateBase defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
