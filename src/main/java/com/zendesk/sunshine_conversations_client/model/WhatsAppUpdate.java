...
public class WhatsAppUpdate implements IntegrationUpdate {
  ...
  public WhatsAppUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public WhatsAppUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public WhatsAppUpdate hsmFallbackLanguage(@jakarta.annotation.Nullable String hsmFallbackLanguage) {
  ...
  public WhatsAppUpdate accountId(@jakarta.annotation.Nullable String accountId) {
  ...
  public WhatsAppUpdate accountManagementAccessToken(@jakarta.annotation.Nullable String accountManagementAccessToken) {
