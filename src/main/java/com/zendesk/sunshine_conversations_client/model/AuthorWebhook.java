...
public class AuthorWebhook {
  ...
  public AuthorWebhook type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public AuthorWebhook userId(@jakarta.annotation.Nullable String userId) {
  ...
  public AuthorWebhook user(@jakarta.annotation.Nullable User user) {
