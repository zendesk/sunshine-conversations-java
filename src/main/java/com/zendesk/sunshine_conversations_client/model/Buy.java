...
public class Buy extends Action {
  ...
  public Buy type(@jakarta.annotation.Nonnull String type) {
  ...
  public Buy text(@jakarta.annotation.Nonnull String text) {
  ...
  public Buy amount(@jakarta.annotation.Nonnull Integer amount) {
  ...
  public Buy currency(@jakarta.annotation.Nullable String currency) {
  ...
  public Buy metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
