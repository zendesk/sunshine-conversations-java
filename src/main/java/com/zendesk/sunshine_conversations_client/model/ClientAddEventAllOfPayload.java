...
@JsonTypeName("clientAddEvent_allOf_payload")
...
public class ClientAddEventAllOfPayload {
  ...
  public enum ReasonEnum {
    ...
    AUTH_CODE(String.valueOf("authCode"));
  ...
  public ClientAddEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ClientAddEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
  ...
  public ClientAddEventAllOfPayload client(@jakarta.annotation.Nullable Client client) {
  ...
  public ClientAddEventAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public ClientAddEventAllOfPayload source(@jakarta.annotation.Nullable SourceWebhook source) {
