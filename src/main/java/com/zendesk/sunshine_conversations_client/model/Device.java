...
public class Device {
  ...
  public Device id(@jakarta.annotation.Nullable String id) {
  ...
  public Device type(@jakarta.annotation.Nullable TypeEnum type) {
  ...
  public Device guid(@jakarta.annotation.Nullable String guid) {
  ...
  @JsonProperty(JSON_PROPERTY_GUID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGuid(@jakarta.annotation.Nullable String guid) {
    this.guid = guid;
  }

  public Device clientId(@jakarta.annotation.Nullable String clientId) {
  ...
  public Device status(@jakarta.annotation.Nullable StatusEnum status) {
  ...
  public Device integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public Device lastSeen(@jakarta.annotation.Nullable String lastSeen) {
  ...
  public Device pushNotificationToken(@jakarta.annotation.Nullable String pushNotificationToken) {
  ...
  @JsonProperty(JSON_PROPERTY_PUSH_NOTIFICATION_TOKEN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPushNotificationToken(@jakarta.annotation.Nullable String pushNotificationToken) {
    this.pushNotificationToken = pushNotificationToken;
  }

  public Device info(@jakarta.annotation.Nullable Map<String, Object> info) {
  ...
  @JsonProperty(JSON_PROPERTY_INFO)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setInfo(@jakarta.annotation.Nullable Map<String, Object> info) {
    this.info = info;
  }

  public Device appVersion(@jakarta.annotation.Nullable String appVersion) {
