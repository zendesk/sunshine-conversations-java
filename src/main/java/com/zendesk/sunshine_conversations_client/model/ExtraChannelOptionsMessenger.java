...
@JsonTypeName("extraChannelOptions_messenger")
...
public class ExtraChannelOptionsMessenger {
  ...
  public ExtraChannelOptionsMessenger messengerExtensions(@jakarta.annotation.Nullable Boolean messengerExtensions) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSENGER_EXTENSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessengerExtensions(@jakarta.annotation.Nullable Boolean messengerExtensions) {
    this.messengerExtensions = messengerExtensions;
  }

  public ExtraChannelOptionsMessenger webviewShareButton(@jakarta.annotation.Nullable WebviewShareButtonEnum webviewShareButton) {
  ...
  @JsonProperty(JSON_PROPERTY_WEBVIEW_SHARE_BUTTON)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWebviewShareButton(@jakarta.annotation.Nullable WebviewShareButtonEnum webviewShareButton) {
    this.webviewShareButton = webviewShareButton;
  }
