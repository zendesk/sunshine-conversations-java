...
@JsonTypeName("sourceWithCampaignWebhook")
...
public class SourceWithCampaignWebhook {
  ...
  public SourceWithCampaignWebhook() {
  }

  public SourceWithCampaignWebhook type(@jakarta.annotation.Nullable String type) {
  ...
  public SourceWithCampaignWebhook integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public SourceWithCampaignWebhook originalMessageId(@jakarta.annotation.Nullable String originalMessageId) {
  ...
  public SourceWithCampaignWebhook originalMessageTimestamp(@jakarta.annotation.Nullable String originalMessageTimestamp) {
  ...
  public SourceWithCampaignWebhook client(@jakarta.annotation.Nullable Client client) {
  ...
  public SourceWithCampaignWebhook device(@jakarta.annotation.Nullable Device device) {
  ...
  public SourceWithCampaignWebhook campaign(@jakarta.annotation.Nullable Campaign campaign) {
