 ...
 */
@JsonPropertyOrder({
  Mailgun.JSON_PROPERTY_DEFAULT_RESPONDER_ID,
  Mailgun.JSON_PROPERTY_DEFAULT_RESPONDER,
...
public class Mailgun extends Integration {
  ...
  public Mailgun defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Mailgun defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Mailgun type(@jakarta.annotation.Nullable String type) {
  ...
  public Mailgun apiKey(@jakarta.annotation.Nullable String apiKey) {
  ...
  public Mailgun domain(@jakarta.annotation.Nonnull String domain) {
  ...
  public Mailgun incomingAddress(@jakarta.annotation.Nonnull String incomingAddress) {
  ...
  @JsonProperty(JSON_PROPERTY_INCOMING_ADDRESS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIncomingAddress(@jakarta.annotation.Nonnull String incomingAddress) {
    this.incomingAddress = incomingAddress;
  }

  public Mailgun hideUnsubscribeLink(@jakarta.annotation.Nullable Boolean hideUnsubscribeLink) {
  ...
  public Mailgun fromAddress(@jakarta.annotation.Nullable String fromAddress) {
  ...
  @Override
  public Mailgun status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Mailgun displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultResponderId, mailgun.defaultResponderId) &&
        Objects.equals(this.defaultResponder, mailgun.defaultResponder) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, apiKey, domain, incomingAddress, hideUnsubscribeLink, fromAddress, super.hashCode());
  }
