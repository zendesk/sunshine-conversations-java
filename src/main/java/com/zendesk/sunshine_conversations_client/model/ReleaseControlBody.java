...
@JsonTypeName("releaseControlBody")
...
public class ReleaseControlBody {
  ...
  public ReleaseControlBody() {
  }

  public ReleaseControlBody reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public ReleaseControlBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public ReleaseControlBody putMetadataItem(String key, Object metadataItem) {
