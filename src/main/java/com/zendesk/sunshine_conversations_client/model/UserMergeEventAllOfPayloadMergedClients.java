...
@JsonTypeName("userMergeEvent_allOf_payload_mergedClients")
...
public class UserMergeEventAllOfPayloadMergedClients {
  ...
  private Client surviving;

  public static final String JSON_PROPERTY_DISCARDED = "discarded";
  @jakarta.annotation.Nullable
  private Client discarded;

  public UserMergeEventAllOfPayloadMergedClients() {
  }

  public UserMergeEventAllOfPayloadMergedClients surviving(@jakarta.annotation.Nullable Client surviving) {
  ...
  @JsonProperty(JSON_PROPERTY_SURVIVING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSurviving(@jakarta.annotation.Nullable Client surviving) {
    this.surviving = surviving;
  }

  public UserMergeEventAllOfPayloadMergedClients discarded(@jakarta.annotation.Nullable Client discarded) {
  ...
  @JsonProperty(JSON_PROPERTY_DISCARDED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscarded(@jakarta.annotation.Nullable Client discarded) {
    this.discarded = discarded;
  }
