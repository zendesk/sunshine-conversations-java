...
@JsonTypeName("conversationTypingEvent_allOf_payload")
...
public class ConversationTypingEventAllOfPayload {
  ...
  public ConversationTypingEventAllOfPayload() {
  }

  public ConversationTypingEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationTypingEventAllOfPayload activity(@jakarta.annotation.Nullable ConversationTypingEventAllOfPayloadActivity activity) {
  ...
  @JsonProperty(JSON_PROPERTY_ACTIVITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActivity(@jakarta.annotation.Nullable ConversationTypingEventAllOfPayloadActivity activity) {
    this.activity = activity;
  }
