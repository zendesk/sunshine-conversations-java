...
public class ParticipantWithUserId {
  ...
  public ParticipantWithUserId() {
  }

  public ParticipantWithUserId userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ParticipantWithUserId subscribeSDKClient(@jakarta.annotation.Nullable Boolean subscribeSDKClient) {
