...
public class SourceWebhook {
  ...
  public SourceWebhook type(@jakarta.annotation.Nullable String type) {
  ...
  public SourceWebhook integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public SourceWebhook originalMessageId(@jakarta.annotation.Nullable String originalMessageId) {
  ...
  public SourceWebhook originalMessageTimestamp(@jakarta.annotation.Nullable String originalMessageTimestamp) {
  ...
  public SourceWebhook client(@jakarta.annotation.Nullable Client client) {
  ...
  public SourceWebhook device(@jakarta.annotation.Nullable Device device) {
