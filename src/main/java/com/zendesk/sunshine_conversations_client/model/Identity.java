...
public class Identity {
  ...
  public Identity type(@jakarta.annotation.Nullable String type) {
  ...
  public Identity value(@jakarta.annotation.Nullable String value) {
  ...
  public Identity verification(@jakarta.annotation.Nullable String verification) {
  ...
  @JsonProperty(JSON_PROPERTY_VERIFICATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVerification(@jakarta.annotation.Nullable String verification) {
    this.verification = verification;
  }
