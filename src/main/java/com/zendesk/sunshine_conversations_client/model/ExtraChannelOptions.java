...
@JsonTypeName("extraChannelOptions")
...
public class ExtraChannelOptions {
  ...
  public ExtraChannelOptions() {
  }

  public ExtraChannelOptions messenger(@jakarta.annotation.Nullable ExtraChannelOptionsMessenger messenger) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSENGER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessenger(@jakarta.annotation.Nullable ExtraChannelOptionsMessenger messenger) {
    this.messenger = messenger;
  }
