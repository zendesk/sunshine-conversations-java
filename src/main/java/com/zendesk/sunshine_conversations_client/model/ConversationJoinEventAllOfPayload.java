...
@JsonTypeName("conversationJoinEvent_allOf_payload")
...
public class ConversationJoinEventAllOfPayload {
  ...
  public ConversationJoinEventAllOfPayload() {
  }

  public ConversationJoinEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationJoinEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
  ...
  @JsonProperty(JSON_PROPERTY_USER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUser(@jakarta.annotation.Nullable UserTruncated user) {
    this.user = user;
  }
