...
@JsonTypeName("attachmentUploadBody")
...
public class AttachmentUploadBody {
  ...
  public AttachmentUploadBody() {
  }

  public AttachmentUploadBody source(@jakarta.annotation.Nonnull File source) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSource(@jakarta.annotation.Nonnull File source) {
    this.source = source;
  }
