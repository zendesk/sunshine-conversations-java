...
public class App {
  ...
  public App id(@jakarta.annotation.Nullable String id) {
  ...
  public App displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public App settings(@jakarta.annotation.Nullable AppSettings settings) {
  ...
  public App metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
