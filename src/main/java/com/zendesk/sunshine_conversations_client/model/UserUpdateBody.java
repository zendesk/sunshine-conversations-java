...
public class UserUpdateBody {
  ...
  public UserUpdateBody signedUpAt(@jakarta.annotation.Nullable String signedUpAt) {
  ...
  public UserUpdateBody toBeRetained(@jakarta.annotation.Nullable Boolean toBeRetained) {
  ...
  public UserUpdateBody profile(@jakarta.annotation.Nullable Profile profile) {
  ...
  public UserUpdateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
