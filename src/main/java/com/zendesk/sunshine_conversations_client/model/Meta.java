...
public class Meta {
  ...
  public Meta hasMore(@jakarta.annotation.Nullable Boolean hasMore) {
  ...
  public Meta afterCursor(@jakarta.annotation.Nullable String afterCursor) {
  ...
  @JsonProperty(JSON_PROPERTY_AFTER_CURSOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAfterCursor(@jakarta.annotation.Nullable String afterCursor) {
    this.afterCursor = afterCursor;
  }

  public Meta beforeCursor(@jakarta.annotation.Nullable String beforeCursor) {
  ...
  @JsonProperty(JSON_PROPERTY_BEFORE_CURSOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBeforeCursor(@jakarta.annotation.Nullable String beforeCursor) {
    this.beforeCursor = beforeCursor;
  }
