...
public class TemplateMessage extends Content {
  ...
  public TemplateMessage type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public TemplateMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public TemplateMessage template(@jakarta.annotation.Nonnull Object template) {
