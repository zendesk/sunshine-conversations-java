...
public class OfferControlBody {
  ...
  public OfferControlBody switchboardIntegration(@jakarta.annotation.Nonnull String switchboardIntegration) {
  ...
  public OfferControlBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public OfferControlBody putMetadataItem(String key, Object metadataItem) {
