...
@JsonTypeName("telegramUpdate")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class TelegramUpdate implements IntegrationUpdate {
  ...
  public TelegramUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public TelegramUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, telegramUpdate.displayName) &&
        Objects.equals(this.defaultResponderId, telegramUpdate.defaultResponderId);
  }
