...
@JsonTypeName("conversationCreateBody")
...
public class ConversationCreateBody {
  ...
  private List<ParticipantSubSchema> participants = new ArrayList<>();
  ...
  public ConversationCreateBody type(@jakarta.annotation.Nonnull ConversationType type) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setType(@jakarta.annotation.Nonnull ConversationType type) {
    this.type = type;
  }

  public ConversationCreateBody participants(@jakarta.annotation.Nullable List<ParticipantSubSchema> participants) {
  ...
  @JsonProperty(JSON_PROPERTY_PARTICIPANTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParticipants(@jakarta.annotation.Nullable List<ParticipantSubSchema> participants) {
    this.participants = participants;
  }

  public ConversationCreateBody displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public ConversationCreateBody description(@jakarta.annotation.Nullable String description) {
  ...
  public ConversationCreateBody iconUrl(@jakarta.annotation.Nullable URI iconUrl) {
  ...
  public ConversationCreateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
