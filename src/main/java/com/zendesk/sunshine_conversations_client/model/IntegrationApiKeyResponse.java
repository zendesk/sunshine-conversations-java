...
@JsonTypeName("integrationApiKeyResponse")
...
public class IntegrationApiKeyResponse {
  ...
  public IntegrationApiKeyResponse() {
  }

  public IntegrationApiKeyResponse key(@jakarta.annotation.Nullable ApiKey key) {
  ...
  @JsonProperty(JSON_PROPERTY_KEY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKey(@jakarta.annotation.Nullable ApiKey key) {
    this.key = key;
  }
