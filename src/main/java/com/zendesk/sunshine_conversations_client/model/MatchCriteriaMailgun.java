...
@JsonTypeName("mailgun")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class MatchCriteriaMailgun extends MatchCriteria {
  ...
  public MatchCriteriaMailgun type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public MatchCriteriaMailgun integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteriaMailgun primary(@jakarta.annotation.Nullable Boolean primary) {
  ...
  public MatchCriteriaMailgun address(@jakarta.annotation.Nonnull String address) {
  ...
  public MatchCriteriaMailgun subject(@jakarta.annotation.Nullable String subject) {
