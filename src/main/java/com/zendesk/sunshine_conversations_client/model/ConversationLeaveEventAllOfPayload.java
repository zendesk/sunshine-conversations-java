...
@JsonTypeName("conversationLeaveEvent_allOf_payload")
...
public class ConversationLeaveEventAllOfPayload {
  ...
  public ConversationLeaveEventAllOfPayload() {
  }

  public ConversationLeaveEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationLeaveEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
