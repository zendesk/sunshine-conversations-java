...
@JsonTypeName("participantLeaveBody")
...
public class ParticipantLeaveBody {
  ...
  public ParticipantLeaveBody() {
  }

  public ParticipantLeaveBody userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ParticipantLeaveBody userExternalId(@jakarta.annotation.Nullable String userExternalId) {
  ...
  public ParticipantLeaveBody participantId(@jakarta.annotation.Nullable String participantId) {
  ...
  @JsonProperty(JSON_PROPERTY_PARTICIPANT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParticipantId(@jakarta.annotation.Nullable String participantId) {
    this.participantId = participantId;
  }
