...
public class Source {
  ...
  public Source type(@jakarta.annotation.Nonnull String type) {
  ...
  public Source integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public Source originalMessageId(@jakarta.annotation.Nullable String originalMessageId) {
  ...
  public Source originalMessageTimestamp(@jakarta.annotation.Nullable String originalMessageTimestamp) {
  ...
  public Source client(@jakarta.annotation.Nullable Client client) {
  ...
  public Source device(@jakarta.annotation.Nullable Device device) {
