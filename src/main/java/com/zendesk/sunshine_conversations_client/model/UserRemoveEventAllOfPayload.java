...
@JsonTypeName("userRemoveEvent_allOf_payload")
...
public class UserRemoveEventAllOfPayload {
  ...
  public UserRemoveEventAllOfPayload() {
  }

  public UserRemoveEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
  ...
  public boolean equals(Object o) {
    ...
    UserRemoveEventAllOfPayload userRemoveEventAllOfPayload = (UserRemoveEventAllOfPayload) o;
    return Objects.equals(this.user, userRemoveEventAllOfPayload.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserRemoveEventAllOfPayload {\n");
