...
@JsonTypeName("conversationMessageDeliveryFailureEvent_allOf_payload")
...
public class ConversationMessageDeliveryFailureEventAllOfPayload {
  ...
  @jakarta.annotation.Nullable
  private List<ConversationMessageDeliveryPayloadExternalMessagesInner> externalMessages;
  ...
  public ConversationMessageDeliveryFailureEventAllOfPayload() {
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public ConversationMessageDeliveryFailureEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  @JsonProperty(JSON_PROPERTY_CONVERSATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
    this.conversation = conversation;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload message(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadMessage message) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessage(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadMessage message) {
    this.message = message;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload destination(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadDestination destination) {
  ...
  @JsonProperty(JSON_PROPERTY_DESTINATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDestination(@jakarta.annotation.Nullable ConversationMessageDeliveryPayloadDestination destination) {
    this.destination = destination;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload externalMessages(@jakarta.annotation.Nullable List<ConversationMessageDeliveryPayloadExternalMessagesInner> externalMessages) {
    
    this.externalMessages = externalMessages;
    return this;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload addExternalMessagesItem(ConversationMessageDeliveryPayloadExternalMessagesInner externalMessagesItem) {
    if (this.externalMessages == null) {
      this.externalMessages = new ArrayList<>();
    }
    this.externalMessages.add(externalMessagesItem);
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EXTERNAL_MESSAGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExternalMessages(@jakarta.annotation.Nullable List<ConversationMessageDeliveryPayloadExternalMessagesInner> externalMessages) {
    this.externalMessages = externalMessages;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload isFinalEvent(@jakarta.annotation.Nullable Boolean isFinalEvent) {
  ...
  @JsonProperty(JSON_PROPERTY_IS_FINAL_EVENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsFinalEvent(@jakarta.annotation.Nullable Boolean isFinalEvent) {
    this.isFinalEvent = isFinalEvent;
  }

  public ConversationMessageDeliveryFailureEventAllOfPayload error(@jakarta.annotation.Nullable ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError error) {
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(@jakarta.annotation.Nullable ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError error) {
    this.error = error;
  }
