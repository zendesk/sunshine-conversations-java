...
@JsonTypeName("conversationListFilter")
...
public class ConversationListFilter {
  ...
  public ConversationListFilter userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ConversationListFilter userExternalId(@jakarta.annotation.Nullable String userExternalId) {
