...
public class AndroidUpdate {
  ...
  public AndroidUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public AndroidUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public AndroidUpdate projectId(@jakarta.annotation.Nullable String projectId) {
  ...
  public AndroidUpdate clientEmail(@jakarta.annotation.Nullable String clientEmail) {
  ...
  public AndroidUpdate privateKey(@jakarta.annotation.Nullable String privateKey) {
  ...
  public AndroidUpdate serverKey(@jakarta.annotation.Nullable String serverKey) {
  ...
  public AndroidUpdate senderId(@jakarta.annotation.Nullable String senderId) {
  ...
  public AndroidUpdate canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public AndroidUpdate canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
