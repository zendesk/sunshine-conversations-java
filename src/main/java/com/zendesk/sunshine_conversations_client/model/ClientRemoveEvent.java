 ...
 */
@JsonPropertyOrder({
  ClientRemoveEvent.JSON_PROPERTY_ID,
  ClientRemoveEvent.JSON_PROPERTY_TYPE,
  ClientRemoveEvent.JSON_PROPERTY_CREATED_AT,
  ClientRemoveEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("clientRemoveEvent")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ClientRemoveEvent {
  ...
  public ClientRemoveEvent() {
  }

  public ClientRemoveEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ClientRemoveEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ClientRemoveEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ClientRemoveEvent payload(@jakarta.annotation.Nullable ClientRemoveEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ClientRemoveEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientRemoveEvent clientRemoveEvent = (ClientRemoveEvent) o;
    return Objects.equals(this.id, clientRemoveEvent.id) &&
        Objects.equals(this.type, clientRemoveEvent.type) &&
        Objects.equals(this.createdAt, clientRemoveEvent.createdAt) &&
        Objects.equals(this.payload, clientRemoveEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientRemoveEvent {\n");
