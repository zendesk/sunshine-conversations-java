...
@JsonTypeName("conversationListResponse")
...
public class ConversationListResponse {
  ...
  public ConversationListResponse conversations(@jakarta.annotation.Nullable List<Conversation> conversations) {
  ...
  @JsonProperty(JSON_PROPERTY_CONVERSATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversations(@jakarta.annotation.Nullable List<Conversation> conversations) {
    this.conversations = conversations;
  }

  public ConversationListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public ConversationListResponse links(@jakarta.annotation.Nullable Links links) {
