...
public class AppKeyResponse {
  ...
  public AppKeyResponse() {
  }

  public AppKeyResponse key(@jakarta.annotation.Nullable AppKey key) {
  ...
  @JsonProperty(JSON_PROPERTY_KEY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKey(@jakarta.annotation.Nullable AppKey key) {
    this.key = key;
  }
