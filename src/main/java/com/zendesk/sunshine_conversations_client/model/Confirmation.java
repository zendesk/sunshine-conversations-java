...
public class Confirmation {
  ...
  public Confirmation type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public Confirmation message(@jakarta.annotation.Nullable MessagePost message) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessage(@jakarta.annotation.Nullable MessagePost message) {
    this.message = message;
  }
