...
@JsonTypeName("appleMessageOverridePayload")
...
public class AppleMessageOverridePayload {
  ...
  @jakarta.annotation.Nullable
  private List<WithCapabilitiesEnum> withCapabilities = new ArrayList<>();

  public AppleMessageOverridePayload() {
  }

  public AppleMessageOverridePayload payload(@jakarta.annotation.Nullable Object payload) {
  ...
  public AppleMessageOverridePayload withCapabilities(@jakarta.annotation.Nullable List<WithCapabilitiesEnum> withCapabilities) {
  ...
  @JsonProperty(JSON_PROPERTY_WITH_CAPABILITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWithCapabilities(@jakarta.annotation.Nullable List<WithCapabilitiesEnum> withCapabilities) {
    this.withCapabilities = withCapabilities;
  }
