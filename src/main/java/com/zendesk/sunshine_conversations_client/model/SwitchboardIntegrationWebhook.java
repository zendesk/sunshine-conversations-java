...
@JsonTypeName("switchboardIntegrationWebhook")
...
public class SwitchboardIntegrationWebhook {
  ...
  public SwitchboardIntegrationWebhook id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardIntegrationWebhook name(@jakarta.annotation.Nullable String name) {
  ...
  public SwitchboardIntegrationWebhook integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public SwitchboardIntegrationWebhook integrationType(@jakarta.annotation.Nullable String integrationType) {
