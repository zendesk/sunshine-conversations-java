...
public class Viber extends Integration {
  ...
  public Viber defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Viber defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Viber type(@jakarta.annotation.Nullable String type) {
  ...
  public Viber token(@jakarta.annotation.Nullable String token) {
  ...
  @Override
  public Viber status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Viber displayName(@jakarta.annotation.Nullable String displayName) {
