...
@JsonTypeName("metaConversionEvent_payload")
...
public class MetaConversionEventPayload {
  ...
  public MetaConversionEventPayload() {
  }

  public MetaConversionEventPayload data(@jakarta.annotation.Nonnull List<Object> data) {
