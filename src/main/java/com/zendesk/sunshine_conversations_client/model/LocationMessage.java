...
/**
 * A location type message includes the coordinates (latitude and longitude) of a location and an
 * optional location object which can include the name and address of the location. Typically sent
 * in response to a Location Request.
 */
@JsonPropertyOrder({
    LocationMessage.JSON_PROPERTY_TYPE,
    LocationMessage.JSON_PROPERTY_TEXT,
    LocationMessage.JSON_PROPERTY_BLOCK_CHAT_INPUT,
    LocationMessage.JSON_PROPERTY_COORDINATES,
    LocationMessage.JSON_PROPERTY_LOCATION
})
@JsonTypeName("location")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class LocationMessage extends Content {
  ...
  public LocationMessage type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public LocationMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public LocationMessage coordinates(
      @jakarta.annotation.Nonnull LocationMessageCoordinates coordinates) {
  ...
  public LocationMessage location(@jakarta.annotation.Nullable LocationMessageLocation location) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, locationMessage.type) &&
        ...
        Objects.equals(this.blockChatInput, locationMessage.blockChatInput) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, text, blockChatInput, coordinates, location);
  }
