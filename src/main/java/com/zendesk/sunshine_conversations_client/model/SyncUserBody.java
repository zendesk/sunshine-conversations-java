...
public class SyncUserBody {
  ...
  public SyncUserBody survivingZendeskId(@jakarta.annotation.Nullable String survivingZendeskId) {
  ...
  @JsonProperty(JSON_PROPERTY_SURVIVING_ZENDESK_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSurvivingZendeskId(@jakarta.annotation.Nullable String survivingZendeskId) {
    this.survivingZendeskId = survivingZendeskId;
  }
