...
@JsonTypeName("matchCriteriaBase")
...
public class MatchCriteriaBase {
  ...
  public MatchCriteriaBase type(@jakarta.annotation.Nonnull String type) {
  ...
  public MatchCriteriaBase integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteriaBase primary(@jakarta.annotation.Nullable Boolean primary) {
