 ...
 */
@JsonPropertyOrder({
  ViberUpdate.JSON_PROPERTY_DISPLAY_NAME,
  ViberUpdate.JSON_PROPERTY_DEFAULT_RESPONDER_ID
})
@JsonTypeName("viberUpdate")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ViberUpdate implements IntegrationUpdate {
  ...
  public ViberUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public ViberUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    ViberUpdate viberUpdate = (ViberUpdate) o;
    return Objects.equals(this.displayName, viberUpdate.displayName) &&
        Objects.equals(this.defaultResponderId, viberUpdate.defaultResponderId);
  }
