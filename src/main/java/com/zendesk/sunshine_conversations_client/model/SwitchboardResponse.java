...
@JsonTypeName("switchboardResponse")
...
public class SwitchboardResponse {
  ...
  public SwitchboardResponse switchboard(@jakarta.annotation.Nullable Switchboard switchboard) {
  ...
  @JsonProperty(JSON_PROPERTY_SWITCHBOARD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSwitchboard(@jakarta.annotation.Nullable Switchboard switchboard) {
    this.switchboard = switchboard;
  }
