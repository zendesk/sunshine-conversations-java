 ...
 */
@JsonPropertyOrder({
  ConversationTypingEvent.JSON_PROPERTY_ID,
  ConversationTypingEvent.JSON_PROPERTY_TYPE,
  ConversationTypingEvent.JSON_PROPERTY_CREATED_AT,
  ConversationTypingEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("conversationTypingEvent")
...
public class ConversationTypingEvent {
  ...
  public ConversationTypingEvent() {
  }

  public ConversationTypingEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationTypingEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationTypingEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationTypingEvent payload(@jakarta.annotation.Nullable ConversationTypingEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationTypingEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationTypingEvent {\n");
