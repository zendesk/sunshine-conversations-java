...
public class WebhookBody {
  ...
  public WebhookBody target(@jakarta.annotation.Nullable String target) {
  ...
  public WebhookBody triggers(@jakarta.annotation.Nullable List<String> triggers) {
  ...
  public WebhookBody includeFullUser(@jakarta.annotation.Nullable Boolean includeFullUser) {
  ...
  public WebhookBody includeFullSource(@jakarta.annotation.Nullable Boolean includeFullSource) {
