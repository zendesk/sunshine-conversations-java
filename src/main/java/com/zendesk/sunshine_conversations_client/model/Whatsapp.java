...
public class Whatsapp extends Integration {
  ...
  public Whatsapp defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Whatsapp defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Whatsapp type(@jakarta.annotation.Nullable String type) {
  ...
  public Whatsapp hsmFallbackLanguage(@jakarta.annotation.Nullable String hsmFallbackLanguage) {
  ...
  public Whatsapp accountId(@jakarta.annotation.Nullable String accountId) {
  ...
  public Whatsapp accountManagementAccessToken(@jakarta.annotation.Nullable String accountManagementAccessToken) {
  ...
  @Override
  public Whatsapp status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Whatsapp displayName(@jakarta.annotation.Nullable String displayName) {
