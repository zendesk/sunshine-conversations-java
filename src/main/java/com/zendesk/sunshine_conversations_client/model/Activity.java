...
public class Activity {
  ...
  public Activity type(@jakarta.annotation.Nullable TypeEnum type) {
  ...
  public Activity source(@jakarta.annotation.Nullable SourceWebhook source) {
  ...
  public Activity author(@jakarta.annotation.Nullable AuthorWebhook author) {
