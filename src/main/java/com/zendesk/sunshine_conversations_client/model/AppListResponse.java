...
public class AppListResponse {
  ...
  public AppListResponse apps(@jakarta.annotation.Nullable List<App> apps) {
  ...
  @JsonProperty(JSON_PROPERTY_APPS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApps(@jakarta.annotation.Nullable List<App> apps) {
    this.apps = apps;
  }

  public AppListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public AppListResponse links(@jakarta.annotation.Nullable Links links) {
