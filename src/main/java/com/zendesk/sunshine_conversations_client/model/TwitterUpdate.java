 ...
 */
@JsonPropertyOrder({
  TwitterUpdate.JSON_PROPERTY_DISPLAY_NAME,
  TwitterUpdate.JSON_PROPERTY_DEFAULT_RESPONDER_ID
})
@JsonTypeName("twitterUpdate")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class TwitterUpdate implements IntegrationUpdate {
  ...
  public TwitterUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public TwitterUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    TwitterUpdate twitterUpdate = (TwitterUpdate) o;
    return Objects.equals(this.displayName, twitterUpdate.displayName) &&
        Objects.equals(this.defaultResponderId, twitterUpdate.defaultResponderId);
  }
