...
@JsonTypeName("conversationMessageDeliveryFailureEvent_allOf_payload_allOf_error")
...
public class ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError {
  ...
  public ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError() {
  }

  public ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError code(@jakarta.annotation.Nullable String code) {
  ...
  public ConversationMessageDeliveryFailureEventAllOfPayloadAllOfError message(@jakarta.annotation.Nullable String message) {
