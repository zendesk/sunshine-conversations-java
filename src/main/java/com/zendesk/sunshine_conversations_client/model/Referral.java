...
public class Referral {
  ...
  @jakarta.annotation.Nullable
  private ReferralDetails details;

  public Referral() {
  }

  public Referral code(@jakarta.annotation.Nullable String code) {
  ...
  public Referral details(@jakarta.annotation.Nullable ReferralDetails details) {
  ...
  @JsonProperty(JSON_PROPERTY_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetails(@jakarta.annotation.Nullable ReferralDetails details) {
    this.details = details;
  }
