...
public class MatchCriteriaTwilio extends MatchCriteria {
  ...
  public MatchCriteriaTwilio type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public MatchCriteriaTwilio integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteriaTwilio primary(@jakarta.annotation.Nullable Boolean primary) {
  ...
  public MatchCriteriaTwilio phoneNumber(@jakarta.annotation.Nonnull String phoneNumber) {
