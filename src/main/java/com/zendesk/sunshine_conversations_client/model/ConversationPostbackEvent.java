...
@JsonTypeName("conversationPostbackEvent")
...
public class ConversationPostbackEvent {
  ...
  public ConversationPostbackEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationPostbackEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationPostbackEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationPostbackEvent payload(@jakarta.annotation.Nullable ConversationPostbackEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationPostbackEventAllOfPayload payload) {
    this.payload = payload;
  }
