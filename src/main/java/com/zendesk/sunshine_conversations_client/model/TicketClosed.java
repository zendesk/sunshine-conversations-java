...
@JsonTypeName("ticket:closed")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class TicketClosed extends ActivityMessage {
  ...
  public TicketClosed() {
    this.type = TypeEnum.TICKET_CLOSED;
  }

  public TicketClosed type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public TicketClosed data(@jakarta.annotation.Nullable Map<String, Object> data) {
  ...
  /**
   * No additional data is supplied with the \&quot;ticket:closed\&quot; activity type at this
   * time.
   *
   * @return data
   */
