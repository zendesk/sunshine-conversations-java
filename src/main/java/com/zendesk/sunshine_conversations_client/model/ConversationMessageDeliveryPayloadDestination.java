...
@JsonTypeName("conversationMessageDeliveryPayload_destination")
...
public class ConversationMessageDeliveryPayloadDestination {
  ...
  public ConversationMessageDeliveryPayloadDestination type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationMessageDeliveryPayloadDestination integrationId(@jakarta.annotation.Nullable String integrationId) {
