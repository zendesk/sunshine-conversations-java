...
@JsonTypeName("switchboardReleaseControl_allOf_payload")
...
public class SwitchboardReleaseControlAllOfPayload {
  ...
  public SwitchboardReleaseControlAllOfPayload() {
  }

  public SwitchboardReleaseControlAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public SwitchboardReleaseControlAllOfPayload metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SwitchboardReleaseControlAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
