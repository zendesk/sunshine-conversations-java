...
public class ParticipantWithUserExternalId {
  ...
  public ParticipantWithUserExternalId() {
  }

  public ParticipantWithUserExternalId userExternalId(@jakarta.annotation.Nullable String userExternalId) {
  ...
  public ParticipantWithUserExternalId subscribeSDKClient(@jakarta.annotation.Nullable Boolean subscribeSDKClient) {
