...
public class GetTokenRequest {
  ...
  public GetTokenRequest code(@jakarta.annotation.Nonnull String code) {
  ...
  public GetTokenRequest grantType(@jakarta.annotation.Nonnull String grantType) {
  ...
  public GetTokenRequest clientId(@jakarta.annotation.Nonnull String clientId) {
  ...
  public GetTokenRequest clientSecret(@jakarta.annotation.Nonnull String clientSecret) {
