 ...
 */
@JsonPropertyOrder({
  ConversationMessageDeliveryChannelEvent.JSON_PROPERTY_ID,
  ConversationMessageDeliveryChannelEvent.JSON_PROPERTY_TYPE,
  ConversationMessageDeliveryChannelEvent.JSON_PROPERTY_CREATED_AT,
  ConversationMessageDeliveryChannelEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("conversationMessageDeliveryChannelEvent")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ConversationMessageDeliveryChannelEvent {
  ...
  public ConversationMessageDeliveryChannelEvent() {
  }

  public ConversationMessageDeliveryChannelEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationMessageDeliveryChannelEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationMessageDeliveryChannelEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationMessageDeliveryChannelEvent payload(@jakarta.annotation.Nullable ConversationMessageDeliveryPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationMessageDeliveryPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConversationMessageDeliveryChannelEvent conversationMessageDeliveryChannelEvent = (ConversationMessageDeliveryChannelEvent) o;
    return Objects.equals(this.id, conversationMessageDeliveryChannelEvent.id) &&
        Objects.equals(this.type, conversationMessageDeliveryChannelEvent.type) &&
        Objects.equals(this.createdAt, conversationMessageDeliveryChannelEvent.createdAt) &&
        Objects.equals(this.payload, conversationMessageDeliveryChannelEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationMessageDeliveryChannelEvent {\n");
