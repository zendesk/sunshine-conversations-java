...
public class MatchCriteriaWhatsapp extends MatchCriteria {
  ...
  public MatchCriteriaWhatsapp() {
    this.type = "whatsapp";
  }

  public MatchCriteriaWhatsapp type(@jakarta.annotation.Nonnull String type) {
  ...
  public MatchCriteriaWhatsapp integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteriaWhatsapp primary(@jakarta.annotation.Nullable Boolean primary) {
  ...
  public MatchCriteriaWhatsapp phoneNumber(@jakarta.annotation.Nonnull String phoneNumber) {
