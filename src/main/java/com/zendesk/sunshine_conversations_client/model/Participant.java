...
public class Participant {
  ...
  public Participant id(@jakarta.annotation.Nullable String id) {
  ...
  public Participant userId(@jakarta.annotation.Nullable String userId) {
  ...
  public Participant unreadCount(@jakarta.annotation.Nullable Integer unreadCount) {
  ...
  public Participant clientAssociations(@jakarta.annotation.Nullable List<ClientAssociation> clientAssociations) {
  ...
  @JsonProperty(JSON_PROPERTY_CLIENT_ASSOCIATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setClientAssociations(@jakarta.annotation.Nullable List<ClientAssociation> clientAssociations) {
    this.clientAssociations = clientAssociations;
  }

  public Participant userExternalId(@jakarta.annotation.Nullable String userExternalId) {
  ...
  public Participant lastRead(@jakarta.annotation.Nullable String lastRead) {
  ...
  @JsonProperty(JSON_PROPERTY_LAST_READ)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLastRead(@jakarta.annotation.Nullable String lastRead) {
    this.lastRead = lastRead;
  }
