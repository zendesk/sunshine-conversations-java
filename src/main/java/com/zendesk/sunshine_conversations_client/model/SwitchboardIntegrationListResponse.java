...
@JsonTypeName("switchboardIntegrationListResponse")
...
public class SwitchboardIntegrationListResponse {
  ...
  private List<SwitchboardIntegration> switchboardIntegrations = new ArrayList<>();

  public SwitchboardIntegrationListResponse() {
  }

  public SwitchboardIntegrationListResponse switchboardIntegrations(@jakarta.annotation.Nullable List<SwitchboardIntegration> switchboardIntegrations) {
  ...
  @JsonProperty(JSON_PROPERTY_SWITCHBOARD_INTEGRATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSwitchboardIntegrations(@jakarta.annotation.Nullable List<SwitchboardIntegration> switchboardIntegrations) {
    this.switchboardIntegrations = switchboardIntegrations;
  }
