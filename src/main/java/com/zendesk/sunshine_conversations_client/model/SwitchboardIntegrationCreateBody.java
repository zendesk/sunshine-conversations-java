...
@JsonTypeName("switchboardIntegrationCreateBody")
...
public class SwitchboardIntegrationCreateBody {
  ...
  public SwitchboardIntegrationCreateBody name(@jakarta.annotation.Nonnull String name) {
  ...
  public SwitchboardIntegrationCreateBody integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public SwitchboardIntegrationCreateBody integrationType(@jakarta.annotation.Nullable String integrationType) {
  ...
  public SwitchboardIntegrationCreateBody deliverStandbyEvents(@jakarta.annotation.Nullable Boolean deliverStandbyEvents) {
  ...
  public SwitchboardIntegrationCreateBody nextSwitchboardIntegrationId(@jakarta.annotation.Nullable String nextSwitchboardIntegrationId) {
  ...
  public SwitchboardIntegrationCreateBody messageHistoryCount(@jakarta.annotation.Nullable Integer messageHistoryCount) {
