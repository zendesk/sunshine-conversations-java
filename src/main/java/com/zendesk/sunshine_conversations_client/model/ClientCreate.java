...
public class ClientCreate {
  ...
  public ClientCreate matchCriteria(@jakarta.annotation.Nonnull MatchCriteria matchCriteria) {
  ...
  @JsonProperty(JSON_PROPERTY_MATCH_CRITERIA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMatchCriteria(@jakarta.annotation.Nonnull MatchCriteria matchCriteria) {
    this.matchCriteria = matchCriteria;
  }

  public ClientCreate confirmation(@jakarta.annotation.Nonnull Confirmation confirmation) {
  ...
  @JsonProperty(JSON_PROPERTY_CONFIRMATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setConfirmation(@jakarta.annotation.Nonnull Confirmation confirmation) {
    this.confirmation = confirmation;
  }

  public ClientCreate target(@jakarta.annotation.Nonnull Target target) {
