...
@JsonTypeName("deviceListResponse")
...
public class DeviceListResponse {
  ...
  public DeviceListResponse devices(@jakarta.annotation.Nullable List<Device> devices) {
  ...
  @JsonProperty(JSON_PROPERTY_DEVICES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDevices(@jakarta.annotation.Nullable List<Device> devices) {
    this.devices = devices;
  }
