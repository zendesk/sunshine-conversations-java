...
public class Unity extends Integration {
  ...
  public Unity defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Unity defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Unity type(@jakarta.annotation.Nullable String type) {
  ...
  public Unity canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public Unity canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
  ...
  @Override
  public Unity status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Unity displayName(@jakarta.annotation.Nullable String displayName) {
