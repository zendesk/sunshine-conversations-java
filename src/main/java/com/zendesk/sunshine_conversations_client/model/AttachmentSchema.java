...
public class AttachmentSchema {
  ...
  public AttachmentSchema() {
  }

  public AttachmentSchema mediaUrl(@jakarta.annotation.Nullable String mediaUrl) {
  ...
  public AttachmentSchema mediaType(@jakarta.annotation.Nullable String mediaType) {
