...
@JsonTypeName("conversationLeaveEvent")
...
public class ConversationLeaveEvent {
  ...
  public ConversationLeaveEvent() {
  }

  public ConversationLeaveEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationLeaveEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationLeaveEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationLeaveEvent payload(@jakarta.annotation.Nullable ConversationLeaveEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationLeaveEventAllOfPayload payload) {
    this.payload = payload;
  }
