...
public class MessageWebhook {
  ...
  public MessageWebhook id(@jakarta.annotation.Nullable String id) {
  ...
  public MessageWebhook received(@jakarta.annotation.Nullable String received) {
  ...
  public MessageWebhook author(@jakarta.annotation.Nullable AuthorWebhook author) {
  ...
  public MessageWebhook content(@jakarta.annotation.Nullable Content content) {
  ...
  public MessageWebhook source(@jakarta.annotation.Nullable MessageWebhookSource source) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(@jakarta.annotation.Nullable MessageWebhookSource source) {
    this.source = source;
  }

  public MessageWebhook quotedMessage(@jakarta.annotation.Nullable QuotedMessage quotedMessage) {
  ...
  public MessageWebhook metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public MessageWebhook putMetadataItem(String key, Object metadataItem) {
  ...
  public MessageWebhook deleted(@jakarta.annotation.Nullable Boolean deleted) {
