...
@JsonTypeName("conversationMessageDeliveryFailureEvent")
...
public class ConversationMessageDeliveryFailureEvent {
  ...
  public ConversationMessageDeliveryFailureEvent() {
  }

  public ConversationMessageDeliveryFailureEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationMessageDeliveryFailureEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationMessageDeliveryFailureEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationMessageDeliveryFailureEvent payload(@jakarta.annotation.Nullable ConversationMessageDeliveryFailureEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationMessageDeliveryFailureEventAllOfPayload payload) {
    this.payload = payload;
  }
