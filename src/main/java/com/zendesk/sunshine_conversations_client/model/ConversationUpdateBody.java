...
@JsonTypeName("conversationUpdateBody")
...
public class ConversationUpdateBody {
  ...
  public ConversationUpdateBody() {
  }

  public ConversationUpdateBody displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public ConversationUpdateBody description(@jakarta.annotation.Nullable String description) {
  ...
  public ConversationUpdateBody iconUrl(@jakarta.annotation.Nullable URI iconUrl) {
  ...
  public ConversationUpdateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public ConversationUpdateBody putMetadataItem(String key, Object metadataItem) {
