...
@JsonTypeName("userMergeEvent_allOf_payload_mergedUsers")
...
public class UserMergeEventAllOfPayloadMergedUsers {
  ...
  public UserMergeEventAllOfPayloadMergedUsers() {
  }

  public UserMergeEventAllOfPayloadMergedUsers surviving(@jakarta.annotation.Nullable User surviving) {
  ...
  @JsonProperty(JSON_PROPERTY_SURVIVING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSurviving(@jakarta.annotation.Nullable User surviving) {
    this.surviving = surviving;
  }

  public UserMergeEventAllOfPayloadMergedUsers discarded(@jakarta.annotation.Nullable User discarded) {
  ...
  @JsonProperty(JSON_PROPERTY_DISCARDED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscarded(@jakarta.annotation.Nullable User discarded) {
    this.discarded = discarded;
  }
