...
public class PrechatCapture {
  ...
  public PrechatCapture() {
  }

  public PrechatCapture avatarUrl(@jakarta.annotation.Nullable String avatarUrl) {
  ...
  public PrechatCapture enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  public PrechatCapture enableEmailLinking(@jakarta.annotation.Nullable Boolean enableEmailLinking) {
  ...
  @JsonProperty(JSON_PROPERTY_ENABLE_EMAIL_LINKING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEnableEmailLinking(@jakarta.annotation.Nullable Boolean enableEmailLinking) {
    this.enableEmailLinking = enableEmailLinking;
  }

  public PrechatCapture fields(@jakarta.annotation.Nullable List<Field> fields) {
