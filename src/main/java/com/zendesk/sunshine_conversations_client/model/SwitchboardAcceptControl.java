 ...
 */
@JsonPropertyOrder({
  SwitchboardAcceptControl.JSON_PROPERTY_ID,
  SwitchboardAcceptControl.JSON_PROPERTY_TYPE,
  SwitchboardAcceptControl.JSON_PROPERTY_CREATED_AT,
  SwitchboardAcceptControl.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardAcceptControl")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardAcceptControl {
  ...
  public SwitchboardAcceptControl() {
  }

  public SwitchboardAcceptControl id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardAcceptControl type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardAcceptControl createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardAcceptControl payload(@jakarta.annotation.Nullable SwitchboardAcceptControlAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable SwitchboardAcceptControlAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardAcceptControl switchboardAcceptControl = (SwitchboardAcceptControl) o;
    return Objects.equals(this.id, switchboardAcceptControl.id) &&
        Objects.equals(this.type, switchboardAcceptControl.type) &&
        Objects.equals(this.createdAt, switchboardAcceptControl.createdAt) &&
        Objects.equals(this.payload, switchboardAcceptControl.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardAcceptControl {\n");
