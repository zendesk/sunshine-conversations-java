...
@JsonTypeName("webhookCreateBody")
...
public class WebhookCreateBody {
  ...
  public WebhookCreateBody() {
  }

  public WebhookCreateBody target(@jakarta.annotation.Nonnull String target) {
  ...
  public WebhookCreateBody triggers(@jakarta.annotation.Nonnull List<String> triggers) {
    
    this.triggers = triggers;
    return this;
  }

  public WebhookCreateBody addTriggersItem(String triggersItem) {
  ...
  @JsonProperty(JSON_PROPERTY_TRIGGERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTriggers(@jakarta.annotation.Nonnull List<String> triggers) {
    this.triggers = triggers;
  }

  public WebhookCreateBody includeFullUser(@jakarta.annotation.Nullable Boolean includeFullUser) {
  ...
  @JsonProperty(JSON_PROPERTY_INCLUDE_FULL_USER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncludeFullUser(@jakarta.annotation.Nullable Boolean includeFullUser) {
    this.includeFullUser = includeFullUser;
  }

  public WebhookCreateBody includeFullSource(@jakarta.annotation.Nullable Boolean includeFullSource) {
  ...
  @JsonProperty(JSON_PROPERTY_INCLUDE_FULL_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncludeFullSource(@jakarta.annotation.Nullable Boolean includeFullSource) {
    this.includeFullSource = includeFullSource;
  }
