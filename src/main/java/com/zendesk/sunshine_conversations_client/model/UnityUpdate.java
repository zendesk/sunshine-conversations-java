 ...
 */
@JsonPropertyOrder({
  UnityUpdate.JSON_PROPERTY_DISPLAY_NAME,
  UnityUpdate.JSON_PROPERTY_DEFAULT_RESPONDER_ID,
  UnityUpdate.JSON_PROPERTY_CAN_USER_SEE_CONVERSATION_LIST,
  UnityUpdate.JSON_PROPERTY_CAN_USER_CREATE_MORE_CONVERSATIONS
})
@JsonTypeName("unityUpdate")
...
public class UnityUpdate implements IntegrationUpdate {
  ...
  public UnityUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public UnityUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public UnityUpdate canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public UnityUpdate canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, unityUpdate.displayName) &&
        ...
        Objects.equals(this.canUserSeeConversationList, unityUpdate.canUserSeeConversationList) &&
        Objects.equals(this.canUserCreateMoreConversations, unityUpdate.canUserCreateMoreConversations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, defaultResponderId, canUserSeeConversationList, canUserCreateMoreConversations);
  }
