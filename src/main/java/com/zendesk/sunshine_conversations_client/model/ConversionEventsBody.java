...
@JsonTypeName("conversionEventsBody")
...
public class ConversionEventsBody {
  ...
  public ConversionEventsBody() {
  }

  public ConversionEventsBody messenger(@jakarta.annotation.Nullable MetaConversionEvent messenger) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSENGER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessenger(@jakarta.annotation.Nullable MetaConversionEvent messenger) {
    this.messenger = messenger;
  }

  public ConversionEventsBody instagram(@jakarta.annotation.Nullable MetaConversionEvent instagram) {
  ...
  @JsonProperty(JSON_PROPERTY_INSTAGRAM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInstagram(@jakarta.annotation.Nullable MetaConversionEvent instagram) {
    this.instagram = instagram;
  }

  public ConversionEventsBody whatsapp(@jakarta.annotation.Nullable MetaConversionEvent whatsapp) {
  ...
  @JsonProperty(JSON_PROPERTY_WHATSAPP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWhatsapp(@jakarta.annotation.Nullable MetaConversionEvent whatsapp) {
    this.whatsapp = whatsapp;
  }
