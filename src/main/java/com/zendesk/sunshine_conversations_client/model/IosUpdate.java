...
public class IosUpdate implements IntegrationUpdate {
  ...
  public IosUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public IosUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public IosUpdate certificate(@jakarta.annotation.Nullable String certificate) {
  ...
  public IosUpdate password(@jakarta.annotation.Nullable String password) {
  ...
  public IosUpdate production(@jakarta.annotation.Nullable Boolean production) {
  ...
  public IosUpdate autoUpdateBadge(@jakarta.annotation.Nullable Boolean autoUpdateBadge) {
  ...
  public IosUpdate canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public IosUpdate canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
