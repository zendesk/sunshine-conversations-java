...
@JsonTypeName("attachmentDeleteBody")
...
public class AttachmentDeleteBody {
  ...
  public AttachmentDeleteBody() {
  }

  public AttachmentDeleteBody mediaUrl(@jakarta.annotation.Nonnull String mediaUrl) {
  ...
  @JsonProperty(JSON_PROPERTY_MEDIA_URL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMediaUrl(@jakarta.annotation.Nonnull String mediaUrl) {
    this.mediaUrl = mediaUrl;
  }
