...
public class Destination {
  ...
  public Destination integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public Destination integrationType(@jakarta.annotation.Nullable String integrationType) {
