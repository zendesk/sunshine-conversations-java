 ...
 */
@JsonPropertyOrder({
  TwilioUpdate.JSON_PROPERTY_DISPLAY_NAME,
  TwilioUpdate.JSON_PROPERTY_DEFAULT_RESPONDER_ID
})
@JsonTypeName("twilioUpdate")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class TwilioUpdate implements IntegrationUpdate {
  ...
  public TwilioUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public TwilioUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public boolean equals(Object o) {
    ...
    TwilioUpdate twilioUpdate = (TwilioUpdate) o;
    return Objects.equals(this.displayName, twilioUpdate.displayName) &&
        Objects.equals(this.defaultResponderId, twilioUpdate.defaultResponderId);
  }
