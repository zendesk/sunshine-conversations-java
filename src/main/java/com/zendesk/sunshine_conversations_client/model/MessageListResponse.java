...
@JsonTypeName("messageListResponse")
...
public class MessageListResponse {
  ...
  public MessageListResponse messages(@jakarta.annotation.Nullable List<Message> messages) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessages(@jakarta.annotation.Nullable List<Message> messages) {
    this.messages = messages;
  }

  public MessageListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public MessageListResponse links(@jakarta.annotation.Nullable Links links) {
