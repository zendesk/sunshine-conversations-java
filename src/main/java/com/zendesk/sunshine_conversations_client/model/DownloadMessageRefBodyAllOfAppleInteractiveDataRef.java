...
@JsonTypeName("downloadMessageRefBody_allOf_apple_interactiveDataRef")
...
public class DownloadMessageRefBodyAllOfAppleInteractiveDataRef {
  ...
  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef() {
  }

  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef url(@jakarta.annotation.Nonnull String url) {
  ...
  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef bid(@jakarta.annotation.Nonnull String bid) {
  ...
  @JsonProperty(JSON_PROPERTY_BID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBid(@jakarta.annotation.Nonnull String bid) {
    this.bid = bid;
  }

  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef key(@jakarta.annotation.Nonnull String key) {
  ...
  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef signature(@jakarta.annotation.Nonnull String signature) {
  ...
  public DownloadMessageRefBodyAllOfAppleInteractiveDataRef owner(@jakarta.annotation.Nonnull String owner) {
