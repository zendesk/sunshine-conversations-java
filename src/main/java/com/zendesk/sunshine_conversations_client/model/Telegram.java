...
public class Telegram extends Integration {
  ...
  public Telegram(
    ...
    @JsonProperty(JSON_PROPERTY_BOT_ID) String botId, 
  ...
  public Telegram defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Telegram defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Telegram type(@jakarta.annotation.Nullable String type) {
  ...
  public Telegram token(@jakarta.annotation.Nullable String token) {
  ...
  @Override
  public Telegram status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Telegram displayName(@jakarta.annotation.Nullable String displayName) {
