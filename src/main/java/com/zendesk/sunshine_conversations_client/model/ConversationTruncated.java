...
@JsonTypeName("conversationTruncated")
...
public class ConversationTruncated {
  ...
  public ConversationTruncated id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationTruncated type(@jakarta.annotation.Nullable ConversationType type) {
  ...
  public ConversationTruncated metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public ConversationTruncated activeSwitchboardIntegration(@jakarta.annotation.Nullable SwitchboardIntegrationWebhook activeSwitchboardIntegration) {
  ...
  public ConversationTruncated pendingSwitchboardIntegration(@jakarta.annotation.Nullable SwitchboardIntegrationWebhook pendingSwitchboardIntegration) {
