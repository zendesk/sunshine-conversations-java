...
public class MessengerUpdate implements IntegrationUpdate {
  ...
  public MessengerUpdate() {
  }

  public MessengerUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public MessengerUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public MessengerUpdate pageAccessToken(@jakarta.annotation.Nullable String pageAccessToken) {
