...
public class Ios extends Integration {
  ...
  public Ios defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Ios defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Ios type(@jakarta.annotation.Nullable String type) {
  ...
  public Ios certificate(@jakarta.annotation.Nullable String certificate) {
  ...
  public Ios password(@jakarta.annotation.Nullable String password) {
  ...
  public Ios production(@jakarta.annotation.Nullable Boolean production) {
  ...
  public Ios autoUpdateBadge(@jakarta.annotation.Nullable Boolean autoUpdateBadge) {
  ...
  public Ios canUserSeeConversationList(@jakarta.annotation.Nullable Boolean canUserSeeConversationList) {
  ...
  public Ios canUserCreateMoreConversations(@jakarta.annotation.Nullable Boolean canUserCreateMoreConversations) {
  ...
  @Override
  public Ios status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Ios displayName(@jakarta.annotation.Nullable String displayName) {
