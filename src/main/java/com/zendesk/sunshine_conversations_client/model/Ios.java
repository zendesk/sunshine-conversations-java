...
public class Ios extends Integration {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, certificate, password, production, autoUpdateBadge, canUserSeeConversationList, canUserCreateMoreConversations, attachmentsEnabled, defaultResponderId, defaultResponder, super.hashCode());
  }
