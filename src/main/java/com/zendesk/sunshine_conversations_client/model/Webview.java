...
/**
 * When a webview actions is clicked/tapped, the provided URI will be loaded in a webview. Channels
 * that do not support webviews will open the fallback URI instead.
 */
@JsonPropertyOrder({
...
@JsonTypeName("webview")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class Webview extends Action {
  ...
  public Webview type(@jakarta.annotation.Nonnull String type) {
  ...
  public Webview uri(@jakarta.annotation.Nonnull String uri) {
  ...
  public Webview text(@jakarta.annotation.Nonnull String text) {
  ...
  public Webview _default(@jakarta.annotation.Nullable Boolean _default) {
  ...
  public Webview metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public Webview extraChannelOptions(
  ...
  public Webview size(@jakarta.annotation.Nullable SizeEnum size) {
    this.size = size;
    return this;
  }
  ...
  public Webview fallback(@jakarta.annotation.Nonnull String fallback) {
  ...
  public Webview openOnReceive(@jakarta.annotation.Nullable Boolean openOnReceive) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, uri, text, _default, metadata, extraChannelOptions, size, fallback,
        openOnReceive);
  }
