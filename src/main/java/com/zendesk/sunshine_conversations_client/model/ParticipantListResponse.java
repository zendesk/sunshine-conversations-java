...
@JsonTypeName("participantListResponse")
...
public class ParticipantListResponse {
  ...
  public ParticipantListResponse participants(@jakarta.annotation.Nullable List<Participant> participants) {
  ...
  public ParticipantListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public ParticipantListResponse links(@jakarta.annotation.Nullable Links links) {
