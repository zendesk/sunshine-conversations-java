...
@JsonTypeName("appKeyListResponse")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class AppKeyListResponse {
  public static final String JSON_PROPERTY_KEYS = "keys";
  @jakarta.annotation.Nullable
  private List<AppKey> keys = new ArrayList<>();

  public AppKeyListResponse() {
  }

  public AppKeyListResponse keys(@jakarta.annotation.Nullable List<AppKey> keys) {
  ...
  @JsonProperty(JSON_PROPERTY_KEYS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKeys(@jakarta.annotation.Nullable List<AppKey> keys) {
    this.keys = keys;
  }
