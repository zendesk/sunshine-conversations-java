...
@JsonTypeName("participantSubSchema")
...
public class ParticipantSubSchema {
  ...
  public ParticipantSubSchema() {
  }

  public ParticipantSubSchema userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ParticipantSubSchema subscribeSDKClient(@jakarta.annotation.Nullable Boolean subscribeSDKClient) {
  ...
  public ParticipantSubSchema userExternalId(@jakarta.annotation.Nullable String userExternalId) {
