...
public class WebhookSubSchema {
  ...
  public WebhookSubSchema id(@jakarta.annotation.Nullable String id) {
  ...
  public WebhookSubSchema version(@jakarta.annotation.Nullable String version) {
