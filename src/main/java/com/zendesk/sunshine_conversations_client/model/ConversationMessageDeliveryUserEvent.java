 ...
 */
@JsonPropertyOrder({
  ConversationMessageDeliveryUserEvent.JSON_PROPERTY_ID,
  ConversationMessageDeliveryUserEvent.JSON_PROPERTY_TYPE,
  ConversationMessageDeliveryUserEvent.JSON_PROPERTY_CREATED_AT,
  ConversationMessageDeliveryUserEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("conversationMessageDeliveryUserEvent")
...
public class ConversationMessageDeliveryUserEvent {
  ...
  public ConversationMessageDeliveryUserEvent() {
  }

  public ConversationMessageDeliveryUserEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationMessageDeliveryUserEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationMessageDeliveryUserEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationMessageDeliveryUserEvent payload(@jakarta.annotation.Nullable ConversationMessageDeliveryPayload payload) {
  ...
  public String toString() {
    ...
    sb.append("class ConversationMessageDeliveryUserEvent {\n");
