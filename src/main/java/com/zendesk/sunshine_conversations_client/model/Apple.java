...
public class Apple extends Integration {
  ...
  public Apple defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Apple defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Apple type(@jakarta.annotation.Nullable String type) {
  ...
  public Apple businessId(@jakarta.annotation.Nonnull String businessId) {
  ...
  @JsonProperty(JSON_PROPERTY_BUSINESS_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBusinessId(@jakarta.annotation.Nonnull String businessId) {
    this.businessId = businessId;
  }

  public Apple apiSecret(@jakarta.annotation.Nonnull String apiSecret) {
  ...
  @JsonProperty(JSON_PROPERTY_API_SECRET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setApiSecret(@jakarta.annotation.Nonnull String apiSecret) {
    this.apiSecret = apiSecret;
  }

  public Apple mspId(@jakarta.annotation.Nonnull String mspId) {
  ...
  @JsonProperty(JSON_PROPERTY_MSP_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMspId(@jakarta.annotation.Nonnull String mspId) {
    this.mspId = mspId;
  }

  public Apple authenticationMessageSecret(@jakarta.annotation.Nullable String authenticationMessageSecret) {
  ...
  @Override
  public Apple status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Apple displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public boolean equals(Object o) {
    ...
    Apple apple = (Apple) o;
    return Objects.equals(this.defaultResponderId, apple.defaultResponderId) &&
        Objects.equals(this.defaultResponder, apple.defaultResponder) &&
        Objects.equals(this.type, apple.type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, businessId, apiSecret, mspId, authenticationMessageSecret, super.hashCode());
  }
