...
@JsonTypeName("userMergeEvent_allOf_payload_mergedConversations")
...
public class UserMergeEventAllOfPayloadMergedConversations {
  ...
  private ConversationTruncated surviving;

  public static final String JSON_PROPERTY_DISCARDED = "discarded";
  @jakarta.annotation.Nullable
  private ConversationTruncated discarded;

  public UserMergeEventAllOfPayloadMergedConversations() {
  }

  public UserMergeEventAllOfPayloadMergedConversations surviving(@jakarta.annotation.Nullable ConversationTruncated surviving) {
  ...
  @JsonProperty(JSON_PROPERTY_SURVIVING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSurviving(@jakarta.annotation.Nullable ConversationTruncated surviving) {
    this.surviving = surviving;
  }

  public UserMergeEventAllOfPayloadMergedConversations discarded(@jakarta.annotation.Nullable ConversationTruncated discarded) {
  ...
  @JsonProperty(JSON_PROPERTY_DISCARDED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscarded(@jakarta.annotation.Nullable ConversationTruncated discarded) {
    this.discarded = discarded;
  }
