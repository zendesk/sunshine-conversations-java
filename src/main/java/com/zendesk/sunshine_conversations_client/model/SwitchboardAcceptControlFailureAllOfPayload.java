...
@JsonTypeName("switchboardAcceptControlFailure_allOf_payload")
...
public class SwitchboardAcceptControlFailureAllOfPayload {
  ...
  public SwitchboardAcceptControlFailureAllOfPayload() {
  }

  public SwitchboardAcceptControlFailureAllOfPayload error(@jakarta.annotation.Nullable Object error) {
  ...
  public SwitchboardAcceptControlFailureAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public SwitchboardAcceptControlFailureAllOfPayload metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public SwitchboardAcceptControlFailureAllOfPayload putMetadataItem(String key, Object metadataItem) {
