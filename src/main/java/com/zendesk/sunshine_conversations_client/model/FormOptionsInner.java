...
@JsonTypeName("formOptions_inner")
...
public class FormOptionsInner {
  ...
  public FormOptionsInner() {
  }

  public FormOptionsInner label(@jakarta.annotation.Nullable String label) {
  ...
  public FormOptionsInner name(@jakarta.annotation.Nullable String name) {
