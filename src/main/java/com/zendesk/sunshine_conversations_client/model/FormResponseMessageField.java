...
@JsonTypeName("formResponseMessageField")
...
public class FormResponseMessageField {
  ...
  public FormResponseMessageField type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public FormResponseMessageField name(@jakarta.annotation.Nonnull String name) {
  ...
  public FormResponseMessageField label(@jakarta.annotation.Nonnull String label) {
  ...
  public FormResponseMessageField text(@jakarta.annotation.Nullable String text) {
  ...
  public FormResponseMessageField email(@jakarta.annotation.Nullable String email) {
  ...
  public FormResponseMessageField select(@jakarta.annotation.Nullable List<Object> select) {
  ...
  public FormResponseMessageField quotedMessageId(@jakarta.annotation.Nullable String quotedMessageId) {
  ...
  @JsonProperty(JSON_PROPERTY_QUOTED_MESSAGE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setQuotedMessageId(@jakarta.annotation.Nullable String quotedMessageId) {
    this.quotedMessageId = quotedMessageId;
  }
