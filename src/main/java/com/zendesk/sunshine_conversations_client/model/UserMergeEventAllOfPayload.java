...
@JsonTypeName("userMergeEvent_allOf_payload")
...
public class UserMergeEventAllOfPayload {
  ...
  @jakarta.annotation.Nullable
  private UserMergeEventAllOfPayloadMergedConversations mergedConversations;

  public static final String JSON_PROPERTY_MERGED_CLIENTS = "mergedClients";
  @jakarta.annotation.Nullable
  private UserMergeEventAllOfPayloadMergedClients mergedClients;

  public static final String JSON_PROPERTY_DISCARDED_METADATA = "discardedMetadata";
  @jakarta.annotation.Nullable
  private Map<String, Object> discardedMetadata;
  ...
  public UserMergeEventAllOfPayload() {
  }

  public UserMergeEventAllOfPayload mergedUsers(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedUsers mergedUsers) {
  ...
  @JsonProperty(JSON_PROPERTY_MERGED_USERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMergedUsers(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedUsers mergedUsers) {
    this.mergedUsers = mergedUsers;
  }

  public UserMergeEventAllOfPayload mergedConversations(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedConversations mergedConversations) {
  ...
  @JsonProperty(JSON_PROPERTY_MERGED_CONVERSATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMergedConversations(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedConversations mergedConversations) {
    this.mergedConversations = mergedConversations;
  }

  public UserMergeEventAllOfPayload mergedClients(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedClients mergedClients) {
  ...
  @JsonProperty(JSON_PROPERTY_MERGED_CLIENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMergedClients(@jakarta.annotation.Nullable UserMergeEventAllOfPayloadMergedClients mergedClients) {
    this.mergedClients = mergedClients;
  }

  public UserMergeEventAllOfPayload discardedMetadata(@jakarta.annotation.Nullable Map<String, Object> discardedMetadata) {
    
    this.discardedMetadata = discardedMetadata;
    return this;
  }

  public UserMergeEventAllOfPayload putDiscardedMetadataItem(String key, Object discardedMetadataItem) {
    if (this.discardedMetadata == null) {
      this.discardedMetadata = new HashMap<>();
    }
    this.discardedMetadata.put(key, discardedMetadataItem);
    return this;
  }
  ...
  public Map<String, Object> getDiscardedMetadata() {
    return discardedMetadata;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DISCARDED_METADATA)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscardedMetadata(@jakarta.annotation.Nullable Map<String, Object> discardedMetadata) {
    this.discardedMetadata = discardedMetadata;
  }

  public UserMergeEventAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
