...
@JsonTypeName("ticket:transfer:email")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class TransferToEmail extends ActivityMessage {
  ...
  public TransferToEmail() {
    this.type = TypeEnum.TICKET_TRANSFER_EMAIL;
  }

  public TransferToEmail type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public TransferToEmail data(@jakarta.annotation.Nullable Map<String, Object> data) {
