...
@JsonPropertyOrder({
  ...
  SwitchboardPassControlAllOfPayload.JSON_PROPERTY_REASON
})
@JsonTypeName("switchboardPassControl_allOf_payload")
...
public class SwitchboardPassControlAllOfPayload {
  ...
  public SwitchboardPassControlAllOfPayload() {
  }

  public SwitchboardPassControlAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public SwitchboardPassControlAllOfPayload metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SwitchboardPassControlAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversation, switchboardPassControlAllOfPayload.conversation) &&
        ...
        Objects.equals(this.reason, switchboardPassControlAllOfPayload.reason);
  }
