 ...
 */
@JsonPropertyOrder({
  SwitchboardAcceptControlFailure.JSON_PROPERTY_ID,
  SwitchboardAcceptControlFailure.JSON_PROPERTY_TYPE,
  SwitchboardAcceptControlFailure.JSON_PROPERTY_CREATED_AT,
  SwitchboardAcceptControlFailure.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardAcceptControlFailure")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardAcceptControlFailure {
  ...
  public SwitchboardAcceptControlFailure() {
  }

  public SwitchboardAcceptControlFailure id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardAcceptControlFailure type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardAcceptControlFailure createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardAcceptControlFailure payload(@jakarta.annotation.Nullable SwitchboardAcceptControlFailureAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable SwitchboardAcceptControlFailureAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardAcceptControlFailure switchboardAcceptControlFailure = (SwitchboardAcceptControlFailure) o;
    return Objects.equals(this.id, switchboardAcceptControlFailure.id) &&
        Objects.equals(this.type, switchboardAcceptControlFailure.type) &&
        Objects.equals(this.createdAt, switchboardAcceptControlFailure.createdAt) &&
        Objects.equals(this.payload, switchboardAcceptControlFailure.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardAcceptControlFailure {\n");
