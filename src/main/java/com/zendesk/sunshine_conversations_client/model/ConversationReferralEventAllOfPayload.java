...
@JsonTypeName("conversationReferralEvent_allOf_payload")
...
public class ConversationReferralEventAllOfPayload {
  ...
  public ConversationReferralEventAllOfPayload() {
  }

  public ConversationReferralEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  /**
   * The conversation a user lands in after being referred. See the &lt;a href&#x3D;\&quot;https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/conversation-referrals/\&quot;&gt;conversation referrals&lt;/a&gt; guide for more details.
   * @return conversation
   */
  @jakarta.annotation.Nullable
  ...
  public ConversationReferralEventAllOfPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public ConversationReferralEventAllOfPayload source(@jakarta.annotation.Nullable SourceWithCampaignWebhook source) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSource(@jakarta.annotation.Nullable SourceWithCampaignWebhook source) {
    this.source = source;
  }

  public ConversationReferralEventAllOfPayload referral(@jakarta.annotation.Nullable Referral referral) {
  ...
  @JsonProperty(JSON_PROPERTY_REFERRAL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReferral(@jakarta.annotation.Nullable Referral referral) {
    this.referral = referral;
  }
