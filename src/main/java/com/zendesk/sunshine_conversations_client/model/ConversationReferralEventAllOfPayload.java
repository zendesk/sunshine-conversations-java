...
public class ConversationReferralEventAllOfPayload {
  ...
  **/
  ...
  @ApiModelProperty(value = "The conversation a user lands in after being referred. See the <a href=\"https://developer.zendesk.com/documentation/conversations/messaging-platform/programmable-conversations/conversation-referrals/\">conversation referrals</a> guide for more details.")
