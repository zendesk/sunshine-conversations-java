...
public class AppSettings {
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "false", value = "A boolean specifying whether users are allowed to be part of several conversations. Enabling `multiConvo` is **irreversible**. ")
