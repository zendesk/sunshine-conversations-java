...
@JsonTypeName("clientAssociation")
...
public class ClientAssociation {
  ...
  public ClientAssociation type(@jakarta.annotation.Nullable ClientType type) {
  ...
  public ClientAssociation clientId(@jakarta.annotation.Nullable String clientId) {
