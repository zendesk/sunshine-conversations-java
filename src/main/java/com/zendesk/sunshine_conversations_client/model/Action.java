...
public class Action {
  ...
  public Action type(@jakarta.annotation.Nonnull String type) {
  ...
  public Action text(@jakarta.annotation.Nonnull String text) {
  ...
  public Action amount(@jakarta.annotation.Nonnull Integer amount) {
  ...
  public Action currency(@jakarta.annotation.Nullable String currency) {
  ...
  public Action metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public Action putMetadataItem(String key, Object metadataItem) {
  ...
  public Action uri(@jakarta.annotation.Nonnull String uri) {
  ...
  public Action _default(@jakarta.annotation.Nullable Boolean _default) {
  ...
  public Action extraChannelOptions(@jakarta.annotation.Nullable ExtraChannelOptions extraChannelOptions) {
  ...
  public Action payload(@jakarta.annotation.Nonnull String payload) {
  ...
  public Action openOnReceive(@jakarta.annotation.Nullable Boolean openOnReceive) {
