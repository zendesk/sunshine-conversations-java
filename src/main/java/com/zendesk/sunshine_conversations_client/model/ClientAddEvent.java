...
import com.zendesk.sunshine_conversations_client.model.ClientAddEventAllOfPayload;
 ...
 */
@JsonPropertyOrder({
  ClientAddEvent.JSON_PROPERTY_ID,
  ClientAddEvent.JSON_PROPERTY_TYPE,
  ClientAddEvent.JSON_PROPERTY_CREATED_AT,
  ClientAddEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("clientAddEvent")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ClientAddEvent {
  ...
  @jakarta.annotation.Nullable
  private ClientAddEventAllOfPayload payload;

  public ClientAddEvent() {
  }

  public ClientAddEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ClientAddEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ClientAddEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ClientAddEvent payload(@jakarta.annotation.Nullable ClientAddEventAllOfPayload payload) {
  ...
  public ClientAddEventAllOfPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ClientAddEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientAddEvent clientAddEvent = (ClientAddEvent) o;
    return Objects.equals(this.id, clientAddEvent.id) &&
        Objects.equals(this.type, clientAddEvent.type) &&
        Objects.equals(this.createdAt, clientAddEvent.createdAt) &&
        Objects.equals(this.payload, clientAddEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientAddEvent {\n");
