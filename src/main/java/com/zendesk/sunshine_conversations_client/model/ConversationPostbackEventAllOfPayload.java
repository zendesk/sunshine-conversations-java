...
@JsonTypeName("conversationPostbackEvent_allOf_payload")
...
public class ConversationPostbackEventAllOfPayload {
  ...
  private PostbackWebhook postback;
  ...
  public ConversationPostbackEventAllOfPayload() {
  }

  public ConversationPostbackEventAllOfPayload postback(@jakarta.annotation.Nullable PostbackWebhook postback) {
  ...
  @JsonProperty(JSON_PROPERTY_POSTBACK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPostback(@jakarta.annotation.Nullable PostbackWebhook postback) {
    this.postback = postback;
  }

  public ConversationPostbackEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationPostbackEventAllOfPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public ConversationPostbackEventAllOfPayload source(@jakarta.annotation.Nullable SourceWithCampaignWebhook source) {
