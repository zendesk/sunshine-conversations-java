...
public class ReferralDetails {
  ...
  public ReferralDetails source(@jakarta.annotation.Nullable String source) {
  ...
  public ReferralDetails type(@jakarta.annotation.Nullable String type) {
  ...
  public ReferralDetails adId(@jakarta.annotation.Nullable String adId) {
  ...
  @JsonProperty(JSON_PROPERTY_AD_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdId(@jakarta.annotation.Nullable String adId) {
    this.adId = adId;
  }
