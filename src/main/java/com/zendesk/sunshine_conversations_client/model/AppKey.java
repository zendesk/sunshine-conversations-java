...
public class AppKey {
  ...
  public AppKey id(@jakarta.annotation.Nullable String id) {
  ...
  public AppKey displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public AppKey secret(@jakarta.annotation.Nullable String secret) {
