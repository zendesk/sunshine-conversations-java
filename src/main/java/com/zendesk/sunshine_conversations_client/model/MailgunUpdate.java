...
public class MailgunUpdate implements IntegrationUpdate {
  ...
  public MailgunUpdate() {
  }

  public MailgunUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public MailgunUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public MailgunUpdate hideUnsubscribeLink(@jakarta.annotation.Nullable Boolean hideUnsubscribeLink) {
  ...
  public MailgunUpdate fromAddress(@jakarta.annotation.Nullable String fromAddress) {
