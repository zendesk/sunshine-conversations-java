...
public class QuotedMessage {
  ...
  public QuotedMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public QuotedMessage message(@jakarta.annotation.Nullable Message message) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessage(@jakarta.annotation.Nullable Message message) {
    this.message = message;
  }

  public QuotedMessage externalMessageId(@jakarta.annotation.Nullable String externalMessageId) {
  ...
  @JsonProperty(JSON_PROPERTY_EXTERNAL_MESSAGE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExternalMessageId(@jakarta.annotation.Nullable String externalMessageId) {
    this.externalMessageId = externalMessageId;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, message, externalMessageId);
  }
