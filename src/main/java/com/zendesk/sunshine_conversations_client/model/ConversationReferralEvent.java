...
@JsonTypeName("conversationReferralEvent")
...
public class ConversationReferralEvent {
  ...
  public ConversationReferralEvent() {
  }

  public ConversationReferralEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationReferralEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationReferralEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationReferralEvent payload(@jakarta.annotation.Nullable ConversationReferralEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationReferralEventAllOfPayload payload) {
    this.payload = payload;
  }
