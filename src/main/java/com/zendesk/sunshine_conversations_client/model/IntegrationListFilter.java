...
@JsonTypeName("integrationListFilter")
...
public class IntegrationListFilter {
  ...
  public IntegrationListFilter() {
  }

  public IntegrationListFilter types(@jakarta.annotation.Nullable String types) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTypes(@jakarta.annotation.Nullable String types) {
    this.types = types;
  }
