...
@JsonTypeName("switchboardIntegrationUpdateBody")
...
public class SwitchboardIntegrationUpdateBody {
  ...
  public SwitchboardIntegrationUpdateBody() {
  }

  public SwitchboardIntegrationUpdateBody name(@jakarta.annotation.Nullable String name) {
  ...
  public SwitchboardIntegrationUpdateBody integrationId(@jakarta.annotation.Nullable String integrationId) {
  ...
  public SwitchboardIntegrationUpdateBody integrationType(@jakarta.annotation.Nullable String integrationType) {
  ...
  public SwitchboardIntegrationUpdateBody deliverStandbyEvents(@jakarta.annotation.Nullable Boolean deliverStandbyEvents) {
  ...
  public SwitchboardIntegrationUpdateBody nextSwitchboardIntegrationId(@jakarta.annotation.Nullable String nextSwitchboardIntegrationId) {
  ...
  public SwitchboardIntegrationUpdateBody messageHistoryCount(@jakarta.annotation.Nullable Integer messageHistoryCount) {
