...
public class TextMessage extends Content {
  ...
  public TextMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public TextMessage text(@jakarta.annotation.Nullable String text) {
  ...
  /**
   * The text content of the message. Required unless &#x60;actions&#x60;, &#x60;htmlText&#x60; or
   * &#x60;markdownText&#x60; is provided.
   *
   * @return text
   */
  @jakarta.annotation.Nullable
  ...
  public TextMessage htmlText(@jakarta.annotation.Nullable String htmlText) {
  ...
  public TextMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public TextMessage markdownText(@jakarta.annotation.Nullable String markdownText) {
  ...
  public TextMessage actions(@jakarta.annotation.Nullable List<Action> actions) {
  ...
  public TextMessage payload(@jakarta.annotation.Nullable String payload) {
