...
import com.zendesk.sunshine_conversations_client.model.SwitchboardOfferControlAllOfPayload;
 ...
 */
@JsonPropertyOrder({
  SwitchboardOfferControl.JSON_PROPERTY_ID,
  SwitchboardOfferControl.JSON_PROPERTY_TYPE,
  SwitchboardOfferControl.JSON_PROPERTY_CREATED_AT,
  SwitchboardOfferControl.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardOfferControl")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardOfferControl {
  ...
  @jakarta.annotation.Nullable
  private SwitchboardOfferControlAllOfPayload payload;

  public SwitchboardOfferControl() {
  }

  public SwitchboardOfferControl id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardOfferControl type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardOfferControl createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardOfferControl payload(@jakarta.annotation.Nullable SwitchboardOfferControlAllOfPayload payload) {
  ...
  public SwitchboardOfferControlAllOfPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable SwitchboardOfferControlAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardOfferControl switchboardOfferControl = (SwitchboardOfferControl) o;
    return Objects.equals(this.id, switchboardOfferControl.id) &&
        Objects.equals(this.type, switchboardOfferControl.type) &&
        Objects.equals(this.createdAt, switchboardOfferControl.createdAt) &&
        Objects.equals(this.payload, switchboardOfferControl.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardOfferControl {\n");
