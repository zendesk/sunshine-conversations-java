...
public class AppUpdateBody {
  ...
  public AppUpdateBody() {
  }

  public AppUpdateBody displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public AppUpdateBody settings(@jakarta.annotation.Nullable AppSettings settings) {
  ...
  @JsonProperty(JSON_PROPERTY_SETTINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSettings(@jakarta.annotation.Nullable AppSettings settings) {
    this.settings = settings;
  }

  public AppUpdateBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public AppUpdateBody putMetadataItem(String key, Object metadataItem) {
