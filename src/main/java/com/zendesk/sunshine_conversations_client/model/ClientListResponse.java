...
@JsonTypeName("clientListResponse")
...
public class ClientListResponse {
  ...
  public ClientListResponse clients(@jakarta.annotation.Nullable List<Client> clients) {
  ...
  @JsonProperty(JSON_PROPERTY_CLIENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setClients(@jakarta.annotation.Nullable List<Client> clients) {
    this.clients = clients;
  }

  public ClientListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public ClientListResponse links(@jakarta.annotation.Nullable Links links) {
