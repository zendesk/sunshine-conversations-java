...
@JsonTypeName("userUpdateEvent_allOf_payload")
...
public class UserUpdateEventAllOfPayload {
  ...
  public UserUpdateEventAllOfPayload() {
  }

  public UserUpdateEventAllOfPayload user(@jakarta.annotation.Nullable User user) {
  ...
  public UserUpdateEventAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public UserUpdateEventAllOfPayload source(@jakarta.annotation.Nullable SourceWebhook source) {
