...
@JsonPropertyOrder({
  ...
  AndroidAllOf.JSON_PROPERTY_CAN_USER_SEE_CONVERSATION_LIST,
...
public class AndroidAllOf {
  ...
  **/
  ...
  @ApiModelProperty(value = "<aside class=\"notice\"><strong>Note:</strong> Firebase Cloud Messaging has deprecated its legacy APIs for HTTP and XMPP. Legacy credentials <code>serverKey</code> and <code>senderId</code> will stop working as of June 2024 and must be replaced with OAuth 2.0 access token based credentials.</aside>  To configure an android integration, first visit the [Firebase Console](https://console.firebase.google.com/).  Generate a private key from the Service accounts tab in the settings.  Copy the `project_id`, `client_email` and `private_key` from the generated JSON file and call the create integrations endpoint with this data. ")
  ...
  **/
  ...
  public AndroidAllOf canUserSeeConversationList(Boolean canUserSeeConversationList) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, androidAllOf.type) &&
        ...
        Objects.equals(this.canUserSeeConversationList, androidAllOf.canUserSeeConversationList) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, projectId, clientEmail, privateKey, serverKey, senderId, canUserSeeConversationList, canUserCreateMoreConversations, attachmentsEnabled);
  }
