...
@JsonTypeName("clientRemoveEvent_allOf_payload")
...
public class ClientRemoveEventAllOfPayload {
  ...
  public ClientRemoveEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ClientRemoveEventAllOfPayload user(@jakarta.annotation.Nullable UserTruncated user) {
  ...
  public ClientRemoveEventAllOfPayload client(@jakarta.annotation.Nullable Client client) {
  ...
  public ClientRemoveEventAllOfPayload reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public ClientRemoveEventAllOfPayload error(@jakarta.annotation.Nullable Object error) {
  ...
  public ClientRemoveEventAllOfPayload source(@jakarta.annotation.Nullable SourceWebhook source) {
