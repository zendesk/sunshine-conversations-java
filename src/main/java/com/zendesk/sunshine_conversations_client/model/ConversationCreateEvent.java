 ...
 */
@JsonPropertyOrder({
  ConversationCreateEvent.JSON_PROPERTY_ID,
  ConversationCreateEvent.JSON_PROPERTY_TYPE,
  ConversationCreateEvent.JSON_PROPERTY_CREATED_AT,
  ConversationCreateEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("conversationCreateEvent")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ConversationCreateEvent {
  ...
  public ConversationCreateEvent() {
  }

  public ConversationCreateEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationCreateEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationCreateEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationCreateEvent payload(@jakarta.annotation.Nullable ConversationCreateEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationCreateEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConversationCreateEvent conversationCreateEvent = (ConversationCreateEvent) o;
    return Objects.equals(this.id, conversationCreateEvent.id) &&
        Objects.equals(this.type, conversationCreateEvent.type) &&
        Objects.equals(this.createdAt, conversationCreateEvent.createdAt) &&
        Objects.equals(this.payload, conversationCreateEvent.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationCreateEvent {\n");
