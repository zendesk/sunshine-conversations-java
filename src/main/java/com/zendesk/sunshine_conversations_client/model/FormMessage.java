...
public class FormMessage extends Content {
  ...
  public FormMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public FormMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public FormMessage fields(@jakarta.annotation.Nonnull List<FormMessageField> fields) {
  ...
  /**
   * An array of objects representing fields associated with the message. Only present in form and
  ...
  @JsonProperty(JSON_PROPERTY_FIELDS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFields(@jakarta.annotation.Nonnull List<FormMessageField> fields) {
    this.fields = fields;
  }
