 ...
 */
@JsonPropertyOrder({
  ConversationMessageEvent.JSON_PROPERTY_ID,
  ConversationMessageEvent.JSON_PROPERTY_TYPE,
  ConversationMessageEvent.JSON_PROPERTY_CREATED_AT,
  ConversationMessageEvent.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("conversationMessageEvent")
...
public class ConversationMessageEvent {
  ...
  public ConversationMessageEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationMessageEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationMessageEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationMessageEvent payload(@jakarta.annotation.Nullable ConversationMessageEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationMessageEventAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, conversationMessageEvent.id) &&
        Objects.equals(this.type, conversationMessageEvent.type) &&
        Objects.equals(this.createdAt, conversationMessageEvent.createdAt) &&
        Objects.equals(this.payload, conversationMessageEvent.payload);
  }
