...
public class LocationRequest {
  ...
  public LocationRequest text(@jakarta.annotation.Nonnull String text) {
  ...
  public LocationRequest metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
