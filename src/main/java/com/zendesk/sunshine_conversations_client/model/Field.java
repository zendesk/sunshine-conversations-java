...
public class Field {
  ...
  public Field type(@jakarta.annotation.Nonnull TypeEnum type) {
  ...
  public Field name(@jakarta.annotation.Nonnull String name) {
  ...
  public Field label(@jakarta.annotation.Nonnull String label) {
  ...
  public Field text(@jakarta.annotation.Nullable String text) {
  ...
  public Field email(@jakarta.annotation.Nullable String email) {
  ...
  public Field select(@jakarta.annotation.Nullable List<Object> select) {
