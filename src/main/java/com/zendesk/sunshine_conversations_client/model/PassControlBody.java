...
public class PassControlBody {
  ...
  public PassControlBody switchboardIntegration(@jakarta.annotation.Nonnull String switchboardIntegration) {
  ...
  @JsonProperty(JSON_PROPERTY_SWITCHBOARD_INTEGRATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSwitchboardIntegration(@jakarta.annotation.Nonnull String switchboardIntegration) {
    this.switchboardIntegration = switchboardIntegration;
  }

  public PassControlBody reason(@jakarta.annotation.Nullable ReasonEnum reason) {
  ...
  public PassControlBody metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public PassControlBody putMetadataItem(String key, Object metadataItem) {
