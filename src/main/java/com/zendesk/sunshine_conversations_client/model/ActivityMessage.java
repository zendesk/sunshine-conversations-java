...
public class ActivityMessage {
  ...
  public ActivityMessage type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }

  /**
   * The type of system activity that generated the message. The value of this field determines the
   * dynamic content that is rendered to the end-user / agent when viewing this message. Each
   * &#x60;type&#x60; value will have a set of pre-defined, localized strings that describe the
   * activity.
   *
   * @return type
   */
  ...
  public ActivityMessage data(@jakarta.annotation.Nullable Map<String, Object> data) {

    this.data = data;
    return this;
  }

  public ActivityMessage putDataItem(String key, Object dataItem) {
    if (this.data == null) {
  ...
  /**
   * No additional data is supplied with the \&quot;ticket:transfer:email\&quot; activity type at
   * this time.
   *
   * @return data
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, activityMessage.type) &&
        Objects.equals(this.data, activityMessage.data);
  }
