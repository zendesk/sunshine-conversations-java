...
public class GetToken200Response {
  ...
  public GetToken200Response accessToken(@jakarta.annotation.Nullable String accessToken) {
  ...
  public GetToken200Response tokenType(@jakarta.annotation.Nullable String tokenType) {
