...
public class IntegrationApiKeyListResponse {
  ...
  public IntegrationApiKeyListResponse() {
  }

  public IntegrationApiKeyListResponse keys(@jakarta.annotation.Nullable List<ApiKey> keys) {
  ...
  @JsonProperty(JSON_PROPERTY_KEYS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKeys(@jakarta.annotation.Nullable List<ApiKey> keys) {
    this.keys = keys;
  }
