...
public class Messagebird extends Integration {
  ...
  @JsonCreator
  public Messagebird(
    @JsonProperty(JSON_PROPERTY_WEBHOOK_SECRET) String webhookSecret, 
  ...
  public Messagebird defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public Messagebird defaultResponder(@jakarta.annotation.Nullable DefaultResponderDefaultResponder defaultResponder) {
  ...
  public Messagebird type(@jakarta.annotation.Nullable String type) {
  ...
  public Messagebird accessKey(@jakarta.annotation.Nullable String accessKey) {
  ...
  public Messagebird signingKey(@jakarta.annotation.Nullable String signingKey) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNING_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSigningKey(@jakarta.annotation.Nullable String signingKey) {
    this.signingKey = signingKey;
  }

  public Messagebird originator(@jakarta.annotation.Nonnull String originator) {
  ...
  @JsonProperty(JSON_PROPERTY_ORIGINATOR)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOriginator(@jakarta.annotation.Nonnull String originator) {
    this.originator = originator;
  }
  ...
  @Override
  public Messagebird status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Messagebird displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultResponderId, defaultResponder, type, accessKey, signingKey, originator, webhookSecret, super.hashCode());
  }
