...
@JsonTypeName("conversationRemoveEvent_allOf_payload")
...
public class ConversationRemoveEventAllOfPayload {
  ...
  public ConversationRemoveEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
