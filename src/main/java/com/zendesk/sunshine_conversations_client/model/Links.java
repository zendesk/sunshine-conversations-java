...
public class Links {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://{subdomain}.zendesk.com/sc/v2/apps?page[before]=fcafad804c39a39648004af9", value = "A link to the previous page. Not specified if there are no previous pages.")
  ...
  **/
  @jakarta.annotation.Nullable
  @ApiModelProperty(example = "https://{subdomain}.zendesk.com/sc/v2/apps?page[after]=5ea868f862cdd24abf010b38", value = "A link to the next page. Not specified if there are no subsequent pages.")
