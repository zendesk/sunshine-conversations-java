...
@JsonTypeName("conversationMessageEvent_allOf_payload")
...
public class ConversationMessageEventAllOfPayload {
  ...
  @jakarta.annotation.Nullable
  private List<MessageWebhook> recentNotifications = new ArrayList<>();

  public ConversationMessageEventAllOfPayload() {
  }

  public ConversationMessageEventAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public ConversationMessageEventAllOfPayload message(@jakarta.annotation.Nullable MessageWebhook message) {
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessage(@jakarta.annotation.Nullable MessageWebhook message) {
    this.message = message;
  }

  public ConversationMessageEventAllOfPayload recentNotifications(@jakarta.annotation.Nullable List<MessageWebhook> recentNotifications) {
  ...
  @JsonProperty(JSON_PROPERTY_RECENT_NOTIFICATIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecentNotifications(@jakarta.annotation.Nullable List<MessageWebhook> recentNotifications) {
    this.recentNotifications = recentNotifications;
  }
