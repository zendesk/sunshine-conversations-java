...
/**
 * A formResponse type message is a response to a form type message. formResponse type messages are
 * only supported as responses to form messages on Web Messenger and cannot be sent via the API.
 */
@JsonPropertyOrder({
...
@JsonTypeName("formResponse")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class FormResponseMessage extends Content {
  ...
  public FormResponseMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public FormResponseMessage fields(
      @jakarta.annotation.Nonnull List<FormResponseMessageField> fields) {
