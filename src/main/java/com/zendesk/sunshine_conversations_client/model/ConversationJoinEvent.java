...
@JsonTypeName("conversationJoinEvent")
...
public class ConversationJoinEvent {
  ...
  public ConversationJoinEvent() {
  }

  public ConversationJoinEvent id(@jakarta.annotation.Nullable String id) {
  ...
  public ConversationJoinEvent type(@jakarta.annotation.Nullable String type) {
  ...
  public ConversationJoinEvent createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public ConversationJoinEvent payload(@jakarta.annotation.Nullable ConversationJoinEventAllOfPayload payload) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable ConversationJoinEventAllOfPayload payload) {
    this.payload = payload;
  }
