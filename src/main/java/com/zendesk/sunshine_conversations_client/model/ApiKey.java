...
public class ApiKey {
  ...
  public ApiKey id(@jakarta.annotation.Nullable String id) {
  ...
  public ApiKey displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public ApiKey secret(@jakarta.annotation.Nullable String secret) {
