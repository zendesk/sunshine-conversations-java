...
public class MatchCriteria {
  ...
  public MatchCriteria type(@jakarta.annotation.Nonnull String type) {
  ...
  public MatchCriteria integrationId(@jakarta.annotation.Nonnull String integrationId) {
  ...
  public MatchCriteria primary(@jakarta.annotation.Nullable Boolean primary) {
  ...
  /**
   * Flag indicating whether the client will become the primary for the target conversation once
   * linking is complete.
   *
   * @return primary
   */
  ...
  public MatchCriteria address(@jakarta.annotation.Nonnull String address) {
  ...
  public MatchCriteria subject(@jakarta.annotation.Nullable String subject) {
  ...
  public MatchCriteria phoneNumber(@jakarta.annotation.Nonnull String phoneNumber) {
  ...
  /**
   * The user’s phone number. It must contain the + prefix and the country code. Examples of valid
   * phone numbers: +1 212-555-2368, +12125552368, +1 212 555 2368. Examples of invalid phone
   * numbers: 212 555 2368, 1 212 555 2368.
   *
   * @return phoneNumber
   */
  @jakarta.annotation.Nonnull
