...
public class Integration {
  ...
  public Integration type(@jakarta.annotation.Nonnull String type) {
  ...
  public Integration status(@jakarta.annotation.Nullable Status status) {
  ...
  public Integration displayName(@jakarta.annotation.Nullable String displayName) {
