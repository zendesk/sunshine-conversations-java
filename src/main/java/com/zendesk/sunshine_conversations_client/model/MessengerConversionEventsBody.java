 ...
 */
@JsonPropertyOrder({
  MessengerConversionEventsBody.JSON_PROPERTY_MESSENGER
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class MessengerConversionEventsBody implements ConversionEventsBody {
  public static final String JSON_PROPERTY_MESSENGER = "messenger";
  @jakarta.annotation.Nullable
  private MetaConversionEvent messenger;

  public MessengerConversionEventsBody() {
  }

  public MessengerConversionEventsBody messenger(@jakarta.annotation.Nullable MetaConversionEvent messenger) {
  ...
  public boolean equals(Object o) {
    ...
    MessengerConversionEventsBody messengerConversionEventsBody = (MessengerConversionEventsBody) o;
    return Objects.equals(this.messenger, messengerConversionEventsBody.messenger);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessengerConversionEventsBody {\n");
