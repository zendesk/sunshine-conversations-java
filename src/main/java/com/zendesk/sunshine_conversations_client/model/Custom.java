...
public class Custom extends Integration {
  ...
  public Custom type(@jakarta.annotation.Nullable String type) {
  ...
  public Custom webhooks(@jakarta.annotation.Nonnull List<Webhook> webhooks) {
  ...
  @JsonProperty(JSON_PROPERTY_WEBHOOKS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setWebhooks(@jakarta.annotation.Nonnull List<Webhook> webhooks) {
    this.webhooks = webhooks;
  }

  @Override
  public Custom status(@jakarta.annotation.Nullable Status status) {
    this.setStatus(status);
    return this;
  }

  @Override
  public Custom displayName(@jakarta.annotation.Nullable String displayName) {
