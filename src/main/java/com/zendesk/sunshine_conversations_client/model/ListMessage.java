...
/**
 * List messages are a vertically scrollable set of items that may each contain text, an image, and
 * message actions. Not all messaging channels fully support list messages. * Facebook Messenger and
 * WeChat have native support. * For LINE and our Android, iOS and Web SDK, Sunshine Conversations
 * converts list messages to carousel. * On WhatsApp, Telegram and Twitter, Sunshine Conversations
 * converts list messages to multiple rich messages. * On all other platforms, Sunshine
 * Conversations converts list messages to raw text.
 */
@JsonPropertyOrder({
    ListMessage.JSON_PROPERTY_TYPE,
    ListMessage.JSON_PROPERTY_BLOCK_CHAT_INPUT,
    ListMessage.JSON_PROPERTY_ITEMS,
    ListMessage.JSON_PROPERTY_ACTIONS
})
@JsonTypeName("list")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class ListMessage extends Content {
  ...
  public ListMessage type(@jakarta.annotation.Nonnull String type) {
  ...
  public ListMessage blockChatInput(@jakarta.annotation.Nullable Boolean blockChatInput) {
  ...
  public ListMessage items(@jakarta.annotation.Nonnull List<Item> items) {
  ...
  public ListMessage actions(@jakarta.annotation.Nullable List<ActionSubset> actions) {
  ...
  /**
   * An array of objects representing the actions associated with the message. The array length is
   * limited by the third party channel.
   *
   * @return actions
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, listMessage.type) &&
        Objects.equals(this.blockChatInput, listMessage.blockChatInput) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, blockChatInput, items, actions);
  }
