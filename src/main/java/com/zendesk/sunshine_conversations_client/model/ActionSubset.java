...
public class ActionSubset {
  ...
  public ActionSubset extraChannelOptions(@jakarta.annotation.Nullable ExtraChannelOptions extraChannelOptions) {
  ...
  @JsonProperty(JSON_PROPERTY_EXTRA_CHANNEL_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExtraChannelOptions(@jakarta.annotation.Nullable ExtraChannelOptions extraChannelOptions) {
    this.extraChannelOptions = extraChannelOptions;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, text, amount, currency, metadata, uri, _default, extraChannelOptions, payload, size, fallback, openOnReceive);
  }
