...
public class ActionSubset {
  ...
  public ActionSubset type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionSubset text(@jakarta.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public ActionSubset amount(@jakarta.annotation.Nonnull Integer amount) {
    this.amount = amount;
    return this;
  }

  /**
   * The amount being charged. It needs to be specified in cents and is an integer (9.99$ -&gt;
   * 999).
   *
   * @return amount
   */
  ...
  public ActionSubset currency(@jakarta.annotation.Nullable String currency) {
  ...
  public ActionSubset metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ActionSubset putMetadataItem(String key, Object metadataItem) {
  ...
  /**
   * Flat object containing custom properties. Strings, numbers and booleans  are the only supported
   * format that can be passed to metadata. The metadata is limited to 4KB in size.
   *
   * @return metadata
   */
  @jakarta.annotation.Nullable
  ...
  public ActionSubset uri(@jakarta.annotation.Nonnull String uri) {
  ...
  public ActionSubset _default(@jakarta.annotation.Nullable Boolean _default) {
  ...
  /**
   * Boolean value indicating whether the action is the default action for a message item in
   * Facebook Messenger.
   *
   * @return _default
   */
  ...
  public ActionSubset extraChannelOptions(
      @jakarta.annotation.Nullable ExtraChannelOptions extraChannelOptions) {
  ...
  @JsonProperty(JSON_PROPERTY_EXTRA_CHANNEL_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExtraChannelOptions(
      @jakarta.annotation.Nullable ExtraChannelOptions extraChannelOptions) {
    this.extraChannelOptions = extraChannelOptions;
  }

  public ActionSubset payload(@jakarta.annotation.Nonnull String payload) {
  ...
  public ActionSubset size(@jakarta.annotation.Nullable SizeEnum size) {
  ...
  public ActionSubset fallback(@jakarta.annotation.Nonnull String fallback) {
  ...
  @JsonProperty(JSON_PROPERTY_FALLBACK)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFallback(@jakarta.annotation.Nonnull String fallback) {
    this.fallback = fallback;
  }

  public ActionSubset openOnReceive(@jakarta.annotation.Nullable Boolean openOnReceive) {
  ...
  /**
   * Boolean value indicating if the webview should open automatically. Only one action per message
   * can be set to true. Currently only supported on the Web Messenger.
   *
  ...
  @JsonProperty(JSON_PROPERTY_OPEN_ON_RECEIVE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOpenOnReceive(@jakarta.annotation.Nullable Boolean openOnReceive) {
    this.openOnReceive = openOnReceive;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, actionSubset.type) &&
        Objects.equals(this.text, actionSubset.text) &&
        Objects.equals(this.amount, actionSubset.amount) &&
        Objects.equals(this.currency, actionSubset.currency) &&
        Objects.equals(this.metadata, actionSubset.metadata) &&
        Objects.equals(this.uri, actionSubset.uri) &&
        Objects.equals(this._default, actionSubset._default) &&
        Objects.equals(this.extraChannelOptions, actionSubset.extraChannelOptions) &&
        Objects.equals(this.payload, actionSubset.payload) &&
        Objects.equals(this.size, actionSubset.size) &&
        Objects.equals(this.fallback, actionSubset.fallback) &&
        Objects.equals(this.openOnReceive, actionSubset.openOnReceive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, text, amount, currency, metadata, uri, _default, extraChannelOptions,
        payload, size, fallback, openOnReceive);
  }
  ...
  public String toString() {
    ...
    sb.append("    extraChannelOptions: ").append(toIndentedString(extraChannelOptions))
        .append("\n");
