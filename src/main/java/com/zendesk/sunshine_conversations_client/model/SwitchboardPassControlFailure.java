 ...
 */
@JsonPropertyOrder({
  SwitchboardPassControlFailure.JSON_PROPERTY_ID,
  SwitchboardPassControlFailure.JSON_PROPERTY_TYPE,
  SwitchboardPassControlFailure.JSON_PROPERTY_CREATED_AT,
  SwitchboardPassControlFailure.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardPassControlFailure")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardPassControlFailure {
  ...
  public SwitchboardPassControlFailure() {
  }

  public SwitchboardPassControlFailure id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardPassControlFailure type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardPassControlFailure createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardPassControlFailure payload(@jakarta.annotation.Nullable SwitchboardAcceptControlFailureAllOfPayload payload) {
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardPassControlFailure switchboardPassControlFailure = (SwitchboardPassControlFailure) o;
    return Objects.equals(this.id, switchboardPassControlFailure.id) &&
        Objects.equals(this.type, switchboardPassControlFailure.type) &&
        Objects.equals(this.createdAt, switchboardPassControlFailure.createdAt) &&
        Objects.equals(this.payload, switchboardPassControlFailure.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardPassControlFailure {\n");
