...
import com.zendesk.sunshine_conversations_client.model.SwitchboardReleaseControlAllOfPayload;
 ...
 */
@JsonPropertyOrder({
  SwitchboardReleaseControl.JSON_PROPERTY_ID,
  SwitchboardReleaseControl.JSON_PROPERTY_TYPE,
  SwitchboardReleaseControl.JSON_PROPERTY_CREATED_AT,
  SwitchboardReleaseControl.JSON_PROPERTY_PAYLOAD
})
@JsonTypeName("switchboardReleaseControl")
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class SwitchboardReleaseControl {
  ...
  @jakarta.annotation.Nullable
  private SwitchboardReleaseControlAllOfPayload payload;

  public SwitchboardReleaseControl() {
  }

  public SwitchboardReleaseControl id(@jakarta.annotation.Nullable String id) {
  ...
  public SwitchboardReleaseControl type(@jakarta.annotation.Nullable String type) {
  ...
  public SwitchboardReleaseControl createdAt(@jakarta.annotation.Nullable String createdAt) {
  ...
  public SwitchboardReleaseControl payload(@jakarta.annotation.Nullable SwitchboardReleaseControlAllOfPayload payload) {
  ...
  public SwitchboardReleaseControlAllOfPayload getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(@jakarta.annotation.Nullable SwitchboardReleaseControlAllOfPayload payload) {
    this.payload = payload;
  }
  ...
  public boolean equals(Object o) {
    ...
    SwitchboardReleaseControl switchboardReleaseControl = (SwitchboardReleaseControl) o;
    return Objects.equals(this.id, switchboardReleaseControl.id) &&
        Objects.equals(this.type, switchboardReleaseControl.type) &&
        Objects.equals(this.createdAt, switchboardReleaseControl.createdAt) &&
        Objects.equals(this.payload, switchboardReleaseControl.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class SwitchboardReleaseControl {\n");
