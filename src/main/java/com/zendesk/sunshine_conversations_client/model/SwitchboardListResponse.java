...
@JsonTypeName("switchboardListResponse")
...
public class SwitchboardListResponse {
  ...
  public SwitchboardListResponse() {
  }

  public SwitchboardListResponse switchboards(@jakarta.annotation.Nullable List<Switchboard> switchboards) {
  ...
  @JsonProperty(JSON_PROPERTY_SWITCHBOARDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSwitchboards(@jakarta.annotation.Nullable List<Switchboard> switchboards) {
    this.switchboards = switchboards;
  }
