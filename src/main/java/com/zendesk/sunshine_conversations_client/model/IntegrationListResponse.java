...
@JsonTypeName("integrationListResponse")
...
public class IntegrationListResponse {
  ...
  public IntegrationListResponse integrations(@jakarta.annotation.Nullable List<Integration> integrations) {
  ...
  public IntegrationListResponse meta(@jakarta.annotation.Nullable Meta meta) {
  ...
  public IntegrationListResponse links(@jakarta.annotation.Nullable Links links) {
