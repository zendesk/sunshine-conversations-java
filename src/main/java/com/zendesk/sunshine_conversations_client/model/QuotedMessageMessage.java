...
public class QuotedMessageMessage extends QuotedMessage {
  ...
  public QuotedMessageMessage() {
    this.type = "message";
  }

  public QuotedMessageMessage type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public QuotedMessageMessage message(@jakarta.annotation.Nullable Message message) {
