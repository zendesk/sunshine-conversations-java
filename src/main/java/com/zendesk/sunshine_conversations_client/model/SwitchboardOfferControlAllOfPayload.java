...
@JsonTypeName("switchboardOfferControl_allOf_payload")
...
public class SwitchboardOfferControlAllOfPayload {
  ...
  public SwitchboardOfferControlAllOfPayload conversation(@jakarta.annotation.Nullable ConversationTruncated conversation) {
  ...
  public SwitchboardOfferControlAllOfPayload metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    
    this.metadata = metadata;
    return this;
  }

  public SwitchboardOfferControlAllOfPayload putMetadataItem(String key, Object metadataItem) {
