...
public class MessagePost {
  ...
  **/
  ...
  public MessagePost schema(String schema) {
   ...
   /**
   * When the &#x60;schema&#x60; is set to &#x60;whatsapp&#x60;, the message is automatically converted to the Sunshine Conversations schema to be stored in the conversation record. The Sunshine Conversations message schema is also used in the API response. Go to [Post Message API](https://docs.smooch.io/guide/whatsapp/#post-message-api) to view an example. 
   * @return schema
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "whatsapp", value = "When the `schema` is set to `whatsapp`, the message is automatically converted to the Sunshine Conversations schema to be stored in the conversation record. The Sunshine Conversations message schema is also used in the API response. Go to [Post Message API](https://docs.smooch.io/guide/whatsapp/#post-message-api) to view an example. ")
