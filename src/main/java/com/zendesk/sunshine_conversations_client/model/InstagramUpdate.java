...
public class InstagramUpdate {
  ...
  public InstagramUpdate() {
  }

  public InstagramUpdate displayName(@jakarta.annotation.Nullable String displayName) {
  ...
  public InstagramUpdate defaultResponderId(@jakarta.annotation.Nullable String defaultResponderId) {
  ...
  public InstagramUpdate pageAccessToken(@jakarta.annotation.Nullable String pageAccessToken) {
