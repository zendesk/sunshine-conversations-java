...
public class ParticipantsApi {
   ...
   */
  public ParticipantResponse joinConversation(@jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nonnull ParticipantJoinBody participantJoinBody) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ParticipantResponse joinConversation(String bearerToken, @jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nonnull ParticipantJoinBody participantJoinBody) throws ApiException {
    Object localVarPostBody = participantJoinBody;
   ...
   * @throws ApiException if fails to make API call
   */
  public Object leaveConversation(@jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nonnull ParticipantLeaveBody participantLeaveBody) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Object leaveConversation(String bearerToken, @jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nonnull ParticipantLeaveBody participantLeaveBody) throws ApiException {
    Object localVarPostBody = participantLeaveBody;
   ...
   * @throws ApiException if fails to make API call
   */
  public ParticipantListResponse listParticipants(@jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nullable Page page) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ParticipantListResponse listParticipants(String bearerToken, @jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String conversationId, @jakarta.annotation.Nullable Page page) throws ApiException {
    Object localVarPostBody = null;
