...
public class OAuthEndpointsApi {
   ...
   */
  public void authorize(@jakarta.annotation.Nonnull String clientId, @jakarta.annotation.Nonnull String responseType, @jakarta.annotation.Nullable String state, @jakarta.annotation.Nullable String redirectUri) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void authorize(String bearerToken, @jakarta.annotation.Nonnull String clientId, @jakarta.annotation.Nonnull String responseType, @jakarta.annotation.Nullable String state, @jakarta.annotation.Nullable String redirectUri) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public GetToken200Response getToken(@jakarta.annotation.Nonnull GetTokenRequest getTokenRequest) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public GetToken200Response getToken(String bearerToken, @jakarta.annotation.Nonnull GetTokenRequest getTokenRequest) throws ApiException {
    Object localVarPostBody = getTokenRequest;
