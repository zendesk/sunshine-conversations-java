...
public class AttachmentsApi {
   ...
   */
  public Object deleteAttachment(@jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull AttachmentDeleteBody attachmentDeleteBody) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Object deleteAttachment(String bearerToken, @jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull AttachmentDeleteBody attachmentDeleteBody) throws ApiException {
    Object localVarPostBody = attachmentDeleteBody;
   ...
   * @throws ApiException if fails to make API call
   */
  public AttachmentResponse uploadAttachment(@jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String access, @jakarta.annotation.Nonnull File source, @jakarta.annotation.Nullable String _for, @jakarta.annotation.Nullable String conversationId) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public AttachmentResponse uploadAttachment(String bearerToken, @jakarta.annotation.Nonnull String appId, @jakarta.annotation.Nonnull String access, @jakarta.annotation.Nonnull File source, @jakarta.annotation.Nullable String _for, @jakarta.annotation.Nullable String conversationId) throws ApiException {
    Object localVarPostBody = null;
