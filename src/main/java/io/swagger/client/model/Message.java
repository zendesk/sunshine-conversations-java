...
import io.swagger.client.model.DisplaySettings;
...
public class Message {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, authorId, role, type, name, text, email, avatarUrl, received, mediaUrl, mediaType, metadata, items, actions, payload, displaySettings);
  }
