...
public class AppUser {
  ...
  private List<Client> pendingClients = new ArrayList<Client>();
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", required = true, value = "The app user's ID, generated automatically.")
  public String getId() {
    return id;
  }
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "null", value = "The app user's userId. This ID is specified by the appMaker. ")
   ...
   * @return givenName
  **/
  @ApiModelProperty(example = "null", value = "The app user's given name.")
   ...
   * @return surname
  **/
  @ApiModelProperty(example = "null", value = "The app user's surname.")
   ...
   * @return email
  **/
  @ApiModelProperty(example = "null", value = "The app user's email.")
   ...
   * @return signedUpAt
  **/
  @ApiModelProperty(example = "null", value = "A datetime string with the format *yyyy-mm-ddThh:mm:ssZ* representing the moment an appUser was created.")
   ...
   * @return properties
  **/
  @ApiModelProperty(example = "null", required = true, value = "Custom properties for the app user.")
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Flag indicating if the conversation has started for the app user.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Flag indicating if the appUser is secured by a JSON Web Token or not.")
   ...
   * @return clients
  **/
  @ApiModelProperty(example = "null", value = "List of clients associated with the app user.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "As clients, but containing linked clients which have not been confirmed yet (i.e. Twilio SMS).")
