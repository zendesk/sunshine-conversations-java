...
public class AppUserPreCreate {
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "null", required = true, value = "The app user's userId. This ID is specified by the appMaker. ")
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(example = "null", value = "Custom properties for the app user.")
