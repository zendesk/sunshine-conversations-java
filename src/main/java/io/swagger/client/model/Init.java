...
import io.swagger.client.model.DeviceInit;
...
public class Init {
  ...
  **/
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "null", value = "The app user's userId. If specified, this ID can be used to invoke APIs. If left blank, an ID will automatically be generated. ")
