...
import io.smooch.v2.client.model.WebUpdateAllOf;
...
@JsonPropertyOrder({
  ...
  WebUpdate.JSON_PROPERTY_CAN_USER_CREATE_CONVERSATION
})
...
public class WebUpdate implements IntegrationUpdate {
  ...
  **/
  ...
  public WebUpdate canUserCreateConversation(Boolean canUserCreateConversation) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.displayName, webUpdate.displayName) &&
        ...
        Objects.equals(this.canUserCreateConversation, webUpdate.canUserCreateConversation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, brandColor, fixedIntroPane, conversationColor, actionColor, displayStyle, buttonIconUrl, buttonWidth, buttonHeight, integrationOrder, businessName, businessIconUrl, backgroundImageUrl, originWhitelist, prechatCapture, canUserCreateConversation);
  }
