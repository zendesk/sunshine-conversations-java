...
public class SwitchboardPassControlFailure {
  ...
  public SwitchboardPassControlFailure id(String id) {
  ...
  **/
  ...
  public SwitchboardPassControlFailure type(String type) {
  ...
  **/
  ...
  public SwitchboardPassControlFailure createdAt(String createdAt) {
  ...
  **/
  ...
  public SwitchboardPassControlFailure payload(SwitchboardAcceptControlFailureAllOfPayload payload) {
