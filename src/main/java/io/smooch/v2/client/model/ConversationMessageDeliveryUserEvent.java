...
public class ConversationMessageDeliveryUserEvent {
  ...
  public ConversationMessageDeliveryUserEvent id(String id) {
  ...
  **/
  ...
  public ConversationMessageDeliveryUserEvent type(String type) {
  ...
  **/
  ...
  public ConversationMessageDeliveryUserEvent createdAt(String createdAt) {
  ...
  **/
  ...
  public ConversationMessageDeliveryUserEvent payload(ConversationMessageDeliveryPayload payload) {
