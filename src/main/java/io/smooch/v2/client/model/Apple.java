...
import io.smooch.v2.client.model.AppleAllOf;
 ...
 */
@JsonPropertyOrder({
  Apple.JSON_PROPERTY_ID,
  Apple.JSON_PROPERTY_TYPE,
  Apple.JSON_PROPERTY_STATUS,
  Apple.JSON_PROPERTY_DISPLAY_NAME,
  Apple.JSON_PROPERTY_BUSINESS_ID,
  Apple.JSON_PROPERTY_API_SECRET,
  Apple.JSON_PROPERTY_MSP_ID
})

public class Apple implements Integration {
  ...
  **/
  ...
  public Apple status(Status status) {
  ...
  **/
  ...
  public Apple displayName(String displayName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Apple apple = (Apple) o;
    return Objects.equals(this.id, apple.id) &&
        Objects.equals(this.type, apple.type) &&
        Objects.equals(this.status, apple.status) &&
        Objects.equals(this.displayName, apple.displayName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, status, displayName, businessId, apiSecret, mspId);
  }
