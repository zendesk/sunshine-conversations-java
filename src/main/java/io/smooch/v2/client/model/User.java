...
import io.smooch.v2.client.model.UserAllOf;
import io.smooch.v2.client.model.UserAllOfProfile;
import io.smooch.v2.client.model.UserTruncated;
...
public class User {
  ...
  private UserAllOfProfile profile;
  ...
  **/
  ...
  public User signedUpAt(String signedUpAt) {
   ...
   /**
   * A datetime string with the format &#x60;YYYY-MM-DDThh:mm:ss.SSSZ&#x60; representing the moment the user was created. 
   * @return signedUpAt
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-01-14T18:55:12.515Z", value = "A datetime string with the format `YYYY-MM-DDThh:mm:ss.SSSZ` representing the moment the user was created. ")
  ...
  **/
  ...
  public User profile(UserAllOfProfile profile) {
  ...
  **/
  ...
  public UserAllOfProfile getProfile() {
    return profile;
  }


  public void setProfile(UserAllOfProfile profile) {
    this.profile = profile;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, externalId, signedUpAt, metadata, profile);
  }
