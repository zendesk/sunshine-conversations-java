 ...
 */
@JsonPropertyOrder({
  IntegrationBase.JSON_PROPERTY_ID,
  IntegrationBase.JSON_PROPERTY_TYPE,
  IntegrationBase.JSON_PROPERTY_STATUS,
  IntegrationBase.JSON_PROPERTY_DISPLAY_NAME
})
...
public class IntegrationBase {
  ...
  **/
  ...
  public IntegrationBase type(String type) {
   ...
   * @return type
  **/
  @ApiModelProperty(example = "android", required = true, value = "The type of integration.")
  ...
  public IntegrationBase status(Status status) {
  ...
  **/
  ...
  public IntegrationBase displayName(String displayName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IntegrationBase integrationBase = (IntegrationBase) o;
    return Objects.equals(this.id, integrationBase.id) &&
        Objects.equals(this.type, integrationBase.type) &&
        Objects.equals(this.status, integrationBase.status) &&
        Objects.equals(this.displayName, integrationBase.displayName);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegrationBase {\n");
