...
public class Author {
  /**
   * The type of the message or activity.
   */
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of the message or activity.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "your-own-id", value = "The externalId of the user. Only supported when role is user.")
