...
import io.smooch.v2.client.model.UserMergeEventAllOf;
import io.smooch.v2.client.model.UserMergeEventAllOfPayload;
...
public class UserMergeEvent {
  ...
  public UserMergeEvent id(String id) {
  ...
  **/
  ...
  public UserMergeEvent type(String type) {
  ...
  **/
  ...
  public UserMergeEvent createdAt(String createdAt) {
