...
import io.smooch.v2.client.model.ViberAllOf;
 ...
 */
@JsonPropertyOrder({
  Viber.JSON_PROPERTY_ID,
  Viber.JSON_PROPERTY_TYPE,
  Viber.JSON_PROPERTY_STATUS,
  Viber.JSON_PROPERTY_DISPLAY_NAME,
  Viber.JSON_PROPERTY_TOKEN,
  Viber.JSON_PROPERTY_URI,
  Viber.JSON_PROPERTY_ACCOUNT_ID
})

public class Viber implements Integration {
  ...
  **/
  ...
  public Viber status(Status status) {
  ...
  **/
  ...
  public Viber displayName(String displayName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Viber viber = (Viber) o;
    return Objects.equals(this.id, viber.id) &&
        Objects.equals(this.type, viber.type) &&
        Objects.equals(this.status, viber.status) &&
        Objects.equals(this.displayName, viber.displayName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, status, displayName, token, uri, accountId);
  }
