...
@JsonPropertyOrder({
  ...
  WebUpdateAllOf.JSON_PROPERTY_CAN_USER_CREATE_CONVERSATION
})
...
public class WebUpdateAllOf {
  ...
  **/
  ...
  public WebUpdateAllOf canUserCreateConversation(Boolean canUserCreateConversation) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.brandColor, webUpdateAllOf.brandColor) &&
        ...
        Objects.equals(this.canUserCreateConversation, webUpdateAllOf.canUserCreateConversation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandColor, fixedIntroPane, conversationColor, actionColor, displayStyle, buttonIconUrl, buttonWidth, buttonHeight, integrationOrder, businessName, businessIconUrl, backgroundImageUrl, originWhitelist, prechatCapture, canUserCreateConversation);
  }
