...
import io.smooch.v2.client.model.MessengerAllOf;
 ...
 */
@JsonPropertyOrder({
  Messenger.JSON_PROPERTY_ID,
  Messenger.JSON_PROPERTY_TYPE,
  Messenger.JSON_PROPERTY_STATUS,
  Messenger.JSON_PROPERTY_DISPLAY_NAME,
  Messenger.JSON_PROPERTY_PAGE_ACCESS_TOKEN,
  Messenger.JSON_PROPERTY_APP_ID,
  Messenger.JSON_PROPERTY_APP_SECRET
})

public class Messenger implements Integration {
  ...
  **/
  ...
  public Messenger status(Status status) {
  ...
  **/
  ...
  public Messenger displayName(String displayName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, messenger.id) &&
        Objects.equals(this.type, messenger.type) &&
        Objects.equals(this.status, messenger.status) &&
        Objects.equals(this.displayName, messenger.displayName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, status, displayName, pageAccessToken, appId, appSecret);
  }
