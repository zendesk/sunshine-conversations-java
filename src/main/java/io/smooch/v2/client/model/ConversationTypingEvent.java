...
import io.smooch.v2.client.model.ConversationTypingEventAllOf;
import io.smooch.v2.client.model.ConversationTypingEventAllOfPayload;
...
public class ConversationTypingEvent {
  ...
  public ConversationTypingEvent id(String id) {
  ...
  **/
  ...
  public ConversationTypingEvent type(String type) {
  ...
  **/
  ...
  public ConversationTypingEvent createdAt(String createdAt) {
  ...
  **/
  ...
  public ConversationTypingEvent payload(ConversationTypingEventAllOfPayload payload) {
