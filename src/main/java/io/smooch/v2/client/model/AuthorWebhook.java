...
import io.smooch.v2.client.model.User;
...
public class AuthorWebhook {
  ...
  **/
  ...
  @ApiModelProperty(example = "5963c0d619a30a2e00de36b8", value = "The id of the user. Only supported when role is `user`.")
  ...
  public AuthorWebhook user(User user) {
   ...
   /**
   * Full profile of the user that authored the message or activity. It is used only in webhook payloads if the &#x60;includeFullUser&#x60; option is enabled.
   * @return user
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Full profile of the user that authored the message or activity. It is used only in webhook payloads if the `includeFullUser` option is enabled.")
