...
import io.smooch.v2.client.model.IntegrationId;
import io.smooch.v2.client.model.IntegrationType;
...
public class Destination {
  ...
  **/
  ...
  @ApiModelProperty(value = "The id of the integration to deliver the message to. Will return an error if the integration does not exist or if the user does not have a client for the integration attached to the conversation. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the integration to deliver the message to. Will return an error if the user does not have a client of that type attached to the conversation. ")
