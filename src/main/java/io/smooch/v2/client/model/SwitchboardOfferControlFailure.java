...
public class SwitchboardOfferControlFailure {
  ...
  public SwitchboardOfferControlFailure id(String id) {
  ...
  **/
  ...
  public SwitchboardOfferControlFailure type(String type) {
  ...
  **/
  ...
  public SwitchboardOfferControlFailure createdAt(String createdAt) {
  ...
  **/
  ...
  public SwitchboardOfferControlFailure payload(SwitchboardAcceptControlFailureAllOfPayload payload) {
