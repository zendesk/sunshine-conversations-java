...
import io.smooch.v2.client.model.ConversationTruncated;
...
public class SwitchboardAcceptControlAllOfPayload {
  ...
  public SwitchboardAcceptControlAllOfPayload conversation(ConversationTruncated conversation) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The conversation from which the switchboard event was fired. Will include an `activeSwitchboardIntegration` representing the integration that has just accepted control.")
  ...
  public SwitchboardAcceptControlAllOfPayload metadata(Object metadata) {
