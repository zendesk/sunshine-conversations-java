...
public class ConversationMessageEventAllOfPayload {
  ...
  private List<Message> recentNotifications = null;
  ...
  **/
  ...
  public ConversationMessageEventAllOfPayload message(Message message) {
  ...
  **/
  ...
  public ConversationMessageEventAllOfPayload recentNotifications(List<Message> recentNotifications) {
    
    this.recentNotifications = recentNotifications;
    return this;
  }

  public ConversationMessageEventAllOfPayload addRecentNotificationsItem(Message recentNotificationsItem) {
    if (this.recentNotifications == null) {
      this.recentNotifications = new ArrayList<Message>();
    }
  ...
  **/
  ...
  public List<Message> getRecentNotifications() {
    return recentNotifications;
  }


  public void setRecentNotifications(List<Message> recentNotifications) {
    this.recentNotifications = recentNotifications;
  }
