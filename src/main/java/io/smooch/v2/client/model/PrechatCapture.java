...
public class PrechatCapture {
  ...
  **/
  ...
  @ApiModelProperty(example = "http://domain.com/images/avatar.png", value = "Sets the URL of the avatar to use for the automatic reply to the prechat capture messages.")
