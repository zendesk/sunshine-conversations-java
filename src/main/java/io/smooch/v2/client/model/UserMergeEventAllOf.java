 ...
 */
@JsonPropertyOrder({
  UserMergeEventAllOf.JSON_PROPERTY_PAYLOAD
})

public class UserMergeEventAllOf {
  public static final String JSON_PROPERTY_PAYLOAD = "payload";
  private UserMergeEventAllOfPayload payload;


  public UserMergeEventAllOf payload(UserMergeEventAllOfPayload payload) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserMergeEventAllOf userMergeEventAllOf = (UserMergeEventAllOf) o;
    return Objects.equals(this.payload, userMergeEventAllOf.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserMergeEventAllOf {\n");
