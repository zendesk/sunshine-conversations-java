...
import io.smooch.v2.client.model.ConversationMessageEventAllOf;
import io.smooch.v2.client.model.ConversationMessageEventAllOfPayload;
...
public class ConversationMessageEvent {
  ...
  public ConversationMessageEvent id(String id) {
  ...
  **/
  ...
  public ConversationMessageEvent type(String type) {
  ...
  **/
  ...
  public ConversationMessageEvent createdAt(String createdAt) {
  ...
  **/
  ...
  public ConversationMessageEvent payload(ConversationMessageEventAllOfPayload payload) {
