...
public class AppSettings {
  ...
  private String attachmentsTokenExpirationSeconds;
  ...
  **/
  ...
  public AppSettings attachmentsTokenExpirationSeconds(String attachmentsTokenExpirationSeconds) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of seconds representing the expiration time of the generated media tokens for private attachments. The JWT will be valid for 2 hours by default. See See <a href=\"https://docs.smooch.io/guide/private-attachments/\">Private Attachments</a> for more information. ")
  @JsonProperty(JSON_PROPERTY_ATTACHMENTS_TOKEN_EXPIRATION_SECONDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getAttachmentsTokenExpirationSeconds() {
    return attachmentsTokenExpirationSeconds;
  }


  public void setAttachmentsTokenExpirationSeconds(String attachmentsTokenExpirationSeconds) {
    this.attachmentsTokenExpirationSeconds = attachmentsTokenExpirationSeconds;
  }
