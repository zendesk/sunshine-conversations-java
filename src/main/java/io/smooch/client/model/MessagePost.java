...
public class MessagePost {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The display name of the message author.")
  ...
  **/
   ...
   * @return avatarUrl
  **/
  @ApiModelProperty(example = "null", value = "The URL of the desired message avatar image.")
  ...
  **/
   ...
   * @return text
  **/
  @ApiModelProperty(example = "null", value = "The message text. Required for text messages. ")
  ...
  **/
   ...
   * @return destination
  **/
  @ApiModelProperty(example = "null", value = "Specifies which channel to deliver a message to. See [list integrations](https://docs.smooch.io/rest/#list-integrations) to get integration ID and type.")
