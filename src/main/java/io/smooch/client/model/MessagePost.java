...
public class MessagePost {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(role, type, name, email, avatarUrl, metadata, payload, text, mediaUrl, mediaType, items, actions, blockChatInput, displaySettings, fields, destination, override);
  }
