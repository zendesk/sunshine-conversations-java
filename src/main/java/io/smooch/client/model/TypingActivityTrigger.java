...
public class TypingActivityTrigger {
   ...
   * @return role
  **/
  @ApiModelProperty(example = "null", required = true, value = "The role of the actor. Must be *appMaker*.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "The type of activity to trigger. Must be either *typing:start* or *typing:stop*.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The name of the app maker that starts or stops typing a response.")
   ...
   * @return avatarUrl
  **/
  @ApiModelProperty(example = "null", value = "The avatar URL of the app maker that starts typing a response.")
