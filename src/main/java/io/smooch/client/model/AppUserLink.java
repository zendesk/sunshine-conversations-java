...
public class AppUserLink {
  ...
  **/
  @ApiModelProperty(value = "The id of the integration to link, it must match the provided type.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, integrationId, phoneNumber, address, givenName, surname, subject, confirmation);
  }
