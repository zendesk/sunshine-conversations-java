...
public class App {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", required = true, value = "The app's ID.")
  public String getId() {
    return id;
  }
   ...
   * @return appToken
  **/
  @ApiModelProperty(example = "null", required = true, value = "The appToken, used to initialize the Web, iOS and Android clients and to make calls to the app user facing API.")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "The app's name.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, appToken, name);
  }
