...
public class MessageItem {
   ...
   * @return title
  **/
  @ApiModelProperty(example = "null", required = true, value = "The title of the message item.")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", value = "The text description, or subtitle.")
   ...
   * @return mediaUrl
  **/
  @ApiModelProperty(example = "null", value = "The image URL to be shown in the carousel/list item.")
   ...
   * @return size
  **/
  @ApiModelProperty(example = "null", value = "The size of the image to be shown in the carousel/list item. Only top item of Facebook Messenger carousel supported. Choose from *compact* and *large*. ")
   ...
   * @return mediaType
  **/
  @ApiModelProperty(example = "null", value = "If a *mediaUrl* was specified, the media type is defined here, for example *image/jpeg*.")
   ...
   * @return actions
  **/
  @ApiModelProperty(example = "null", required = true, value = "Array of [action buttons](https://docs.smooch.io/rest/#action-buttons). At least 1 is required, a maximum of 3 are allowed.")
