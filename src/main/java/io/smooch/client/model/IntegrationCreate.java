...
public class IntegrationCreate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, pageAccessToken, appId, appSecret, accountSid, authToken, phoneNumberSid, token, channelAccessToken, encodingAesKey, fromAddress, certificate, password, autoUpdateBadge, serverKey, senderId, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret);
  }
