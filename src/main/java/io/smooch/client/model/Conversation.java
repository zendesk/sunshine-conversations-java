...
public class Conversation {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", required = true, value = "The conversation ID, generated automatically.")
  public String getId() {
    return id;
  }
   ...
   * @return unreadCount
  **/
  @ApiModelProperty(example = "null", required = true, value = "The number of unread messages in the conversation.")
