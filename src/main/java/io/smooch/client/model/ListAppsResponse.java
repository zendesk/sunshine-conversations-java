...
public class ListAppsResponse {
   ...
   * @return apps
  **/
  @ApiModelProperty(example = "null", value = "The list of apps.")
   ...
   * @return hasMore
  **/
  @ApiModelProperty(example = "null", value = "Flag indicating if there are more apps that are not present in the response.")
   ...
   * @return offset
  **/
  @ApiModelProperty(example = "null", value = "The number of app records skipped in the returned list.")
