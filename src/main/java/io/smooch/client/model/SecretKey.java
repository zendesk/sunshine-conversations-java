...
public class SecretKey {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", required = true, value = "The secret key ID, generated automatically.")
  public String getId() {
    return id;
  }
   ...
   * @return secret
  **/
  @ApiModelProperty(example = "null", required = true, value = "The secret itself.")
