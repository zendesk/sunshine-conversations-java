...
public class Action {
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", required = true, value = "The action type.")
   ...
   * @return text
  **/
  @ApiModelProperty(example = "null", required = true, value = "The button text.")
   ...
   * @return payload
  **/
  @ApiModelProperty(example = "null", value = "The payload to be sent with the resulting webhook. Required for *postback* and *reply* actions. ")
   ...
   * @return metadata
  **/
  @ApiModelProperty(example = "null", value = "Flat JSON object containing any custom properties associated with the action.")
   ...
   * @return amount
  **/
  @ApiModelProperty(example = "null", value = "The amount being charged. It needs to be specified in cents and is an integer. Required for *buy* actions. ")
   ...
   * @return currency
  **/
  @ApiModelProperty(example = "null", value = "The currency of the amount being charged (USD, CAD, etc.).")
   ...
   * @return _default
  **/
  @ApiModelProperty(example = "null", value = "Flag indicating if the message action is the default for a message item in Facebook Messenger.")
   ...
   * @return iconUrl
  **/
  @ApiModelProperty(example = "null", value = "An icon to render next to the reply option (Facebook Messenger and Web Messenger only).")
   ...
   * @return uri
  **/
  @ApiModelProperty(example = "null", value = "The action URI. This is the link that will be used in the clients when clicking the button. Required for *link* actions. ")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Extra options to pass directly to the channel API. See [Extra Channel Options](https://docs.smooch.io/rest#extra-channel-options-schema)")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, text, payload, metadata, amount, currency, _default, iconUrl, uri, extraChannelOptions);
  }
