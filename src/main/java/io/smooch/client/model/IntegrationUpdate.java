...
public class IntegrationUpdate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brandColor, conversationColor, actionColor, displayStyle, buttonIconUrl, buttonWidth, buttonHeight, integrationOrder, businessName, businessIconUrl, backgroundImageUrl, originWhitelist);
  }
