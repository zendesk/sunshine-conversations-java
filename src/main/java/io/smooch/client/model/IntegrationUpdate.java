...
public class IntegrationUpdate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brandColor, conversationColor, actionColor, displayStyle, buttonIconUrl, integrationOrder, businessName, businessIconUrl, backgroundImageUrl);
  }
