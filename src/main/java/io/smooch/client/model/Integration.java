...
public class Integration {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, pageAccessToken, appId, appSecret, accountSid, authToken, phoneNumberSid, token, channelAccessToken, encodingAesKey, fromAddress, certificate, password, autoUpdateBadge, serverKey, senderId, consumerKey, consumerSecret, accessTokenKey, accessTokenSecret);
  }
