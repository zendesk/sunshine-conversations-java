...
public class AppUserApi {
     ...
     */
    public com.squareup.okhttp.Call appUserDeviceUpdateCall(String appId, String userId, String deviceId, DeviceUpdate appUserDeviceUpdateBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = appUserDeviceUpdateBody;
        
        // create path and map variables
        String localVarPath = "/apps/{appId}/appusers/{userId}/devices/{deviceId}"
    ...
    private com.squareup.okhttp.Call appUserDeviceUpdateValidateBeforeCall(String appId, String userId, String deviceId, DeviceUpdate appUserDeviceUpdateBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = appUserDeviceUpdateCall(appId, userId, deviceId, appUserDeviceUpdateBody, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DeviceResponse appUserDeviceUpdate(String appId, String userId, String deviceId, DeviceUpdate appUserDeviceUpdateBody) throws ApiException {
        ApiResponse<DeviceResponse> resp = appUserDeviceUpdateWithHttpInfo(appId, userId, deviceId, appUserDeviceUpdateBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeviceResponse> appUserDeviceUpdateWithHttpInfo(String appId, String userId, String deviceId, DeviceUpdate appUserDeviceUpdateBody) throws ApiException {
        com.squareup.okhttp.Call call = appUserDeviceUpdateValidateBeforeCall(appId, userId, deviceId, appUserDeviceUpdateBody, null, null);
     ...
     */
    public com.squareup.okhttp.Call appUserDeviceUpdateAsync(String appId, String userId, String deviceId, DeviceUpdate appUserDeviceUpdateBody, final ApiCallback<DeviceResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = appUserDeviceUpdateValidateBeforeCall(appId, userId, deviceId, appUserDeviceUpdateBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeviceResponse>(){}.getType();
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AppUserResponse getAppUserEntityIds(String appId, String userId) throws ApiException {
        ApiResponse<AppUserResponse> resp = getAppUserEntityIdsWithHttpInfo(appId, userId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AppUserResponse> getAppUserEntityIdsWithHttpInfo(String appId, String userId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAppUserEntityIdsAsync(String appId, String userId, final ApiCallback<AppUserResponse> callback) throws ApiException {
