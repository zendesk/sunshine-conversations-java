...
public class AppUserApi {
     ...
     * @param appId Identifies the app. (required)
     * @param userId Identifies the user. Can be either the smoochId or the userId. (required)
     * @param integrationIds Comma separated list of integration IDs (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getLinkRequestsCall(String appId, String userId, String integrationIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "integrationIds", integrationIds));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getLinkRequestsValidateBeforeCall(String appId, String userId, String integrationIds, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public LinkRequestResponse getLinkRequests(String appId, String userId, String integrationIds) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LinkRequestResponse> getLinkRequestsWithHttpInfo(String appId, String userId, String integrationIds) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getLinkRequestsAsync(String appId, String userId, String integrationIds, final ApiCallback<LinkRequestResponse> callback) throws ApiException {
