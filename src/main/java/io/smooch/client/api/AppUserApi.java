...
public class AppUserApi {
     ...
     */
    public com.squareup.okhttp.Call deleteAppUserCall(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteAppUserValidateBeforeCall(String appId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteAppUserCall(appId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void deleteAppUser(String appId) throws ApiException {
        deleteAppUserWithHttpInfo(appId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> deleteAppUserWithHttpInfo(String appId) throws ApiException {
        com.squareup.okhttp.Call call = deleteAppUserValidateBeforeCall(appId, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteAppUserAsync(String appId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteAppUserValidateBeforeCall(appId, progressListener, progressRequestListener);
